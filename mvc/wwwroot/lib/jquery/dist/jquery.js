			...
			for ( name in options ) ***REMOVED***
				...
				***REMOVED***
				...
				if ( deep && copy && ( jQuery.isPlainObject( copy ) ||
					...
					if ( copyIsArray && !Array.isArray( src ) ) ***REMOVED***
						clone = [];
					***REMOVED*** else if ( !copyIsArray && !jQuery.isPlainObject( src ) ) ***REMOVED***
...
jQuery.extend( ***REMOVED***
	...
	***REMOVED***,
	...
	globalEval: function( code, options, doc ) ***REMOVED***
		DOMEval( code, ***REMOVED*** nonce: options && options.nonce ***REMOVED***, doc );
	***REMOVED***,
		...
		if ( documentIsHTML ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( support.qsa &&
				...
				( nodeType !== 1 || context.nodeName.toLowerCase() !== "object" ) ) ***REMOVED***
				...
				if ( nodeType === 1 &&
					( rdescend.test( selector ) || rcombinators.test( selector ) ) ) ***REMOVED***
	...
	if ( ( support.qsa = rnative.test( document.querySelectorAll ) ) ) ***REMOVED***
		...
		assert( function( el ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( !el.querySelectorAll( "[name='']" ).length ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( compare & 1 ||
			...
			if ( a == document || a.ownerDocument == preferredDoc &&
				contains( preferredDoc, a ) ) ***REMOVED***
				return -1;
			***REMOVED***
			...
			if ( b == document || b.ownerDocument == preferredDoc &&
				contains( preferredDoc, b ) ) ***REMOVED***
				return 1;
			***REMOVED***
			...
			return pattern ||
				( pattern = new RegExp( "(^|" + whitespace +
					")" + className + "(" + whitespace + "|$)" ) ) && classCache(
						className, function( elem ) ***REMOVED***
							return pattern.test(
		...
		"CHILD": function( type, what, _argument, first, last ) ***REMOVED***
			...
			return first === 1 && last === 0 ?
				...
				***REMOVED*** :
				...
				function( elem, _context, xml ) ***REMOVED***
	...
	pseudos: ***REMOVED***
		...
		"not": markFunction( function( selector ) ***REMOVED***
			...
			return matcher[ expando ] ?
				markFunction( function( seed, matches, _context, xml ) ***REMOVED***
					var elem,
			...
			if ( matcher[ expando ] ) ***REMOVED***
				...
				***REMOVED***
				return setMatcher(
					...
					tokens
						.slice( 0, i - 1 )
						.concat( ***REMOVED*** value: tokens[ i - 2 ].type === " " ? "*" : "" ***REMOVED*** )
					).replace( rtrim, "$1" ),
					matcher,
	...
	***REMOVED***,
	contents: function( elem ) ***REMOVED***
		if ( elem.contentDocument != null &&
			...
			getProto( elem.contentDocument ) ) ***REMOVED***
...
var documentElement = document.documentElement;
	...
	var isAttached = function( elem ) ***REMOVED***
		...
		***REMOVED***,
		composed = ***REMOVED*** composed: true ***REMOVED***;
		...
		while ( ( matched = handlerQueue[ i++ ] ) && !event.isPropagationStopped() ) ***REMOVED***
			...
			while ( ( handleObj = matched.handlers[ j++ ] ) &&
				...
				if ( !event.rnamespace || handleObj.namespace === false ||
					event.rnamespace.test( handleObj.namespace ) ) ***REMOVED***
		...
		click: ***REMOVED***
			...
			setup: function( data ) ***REMOVED***
				...
				if ( rcheckableType.test( el.type ) &&
					el.click && nodeName( el, "input" ) ) ***REMOVED***
...
function leverageNative( el, type, expectSync ) ***REMOVED***
	...
	if ( !expectSync ) ***REMOVED***
		if ( dataPriv.get( el, type ) === undefined ) ***REMOVED***
	...
	***REMOVED***
	...
	jQuery.event.add( el, type, ***REMOVED***
		namespace: false,
		handler: function( event ) ***REMOVED***
			...
			***REMOVED*** else if ( saved.length ) ***REMOVED***
				...
				dataPriv.set( this, type, ***REMOVED***
...
jQuery.each( ***REMOVED*** focus: "focusin", blur: "focusout" ***REMOVED***, function( type, delegateType ) ***REMOVED***
	...
	for ( ; ( node = nodes[ i ] ) != null; i++ ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( node.parentNode ) ***REMOVED***
			if ( keepData && isAttached( node ) ) ***REMOVED***
...
function curCSS( elem, name, computed ) ***REMOVED***
	...
	if ( computed ) ***REMOVED***
		...
		if ( ret === "" && !isAttached( elem ) ) ***REMOVED***
...
function getWidthOrHeight( elem, dimension, extra ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( ( !support.boxSizingReliable() && isBorderBox ||
		...
		elem.getClientRects().length ) ***REMOVED***
		...
		***REMOVED***,
		set: function( tween ) ***REMOVED***
			...
			***REMOVED*** else if ( tween.elem.nodeType === 1 && (
					...
					tween.elem.style[ finalPropName( tween.prop ) ] != null ) ) ***REMOVED***
...
jQuery.each( jQuery.expr.match.bool.source.match( /\w+/g ), function( _i, name ) ***REMOVED***
...
var nonce = ***REMOVED*** guid: Date.now() ***REMOVED***;
		...
		***REMOVED***
		...
		function done( status, nativeStatusText, responses, headers ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( !isSuccess && jQuery.inArray( "script", s.dataTypes ) > -1 ) ***REMOVED***
...
jQuery.ajaxPrefilter( function( s ) ***REMOVED***
	var i;
	for ( i in s.headers ) ***REMOVED***
		if ( i.toLowerCase() === "content-type" ) ***REMOVED***
		...
		return ***REMOVED***
			send: function( _, complete ) ***REMOVED***
				script = jQuery( "<script>" )
					.attr( s.scriptAttrs || ***REMOVED******REMOVED*** )
					.prop( ***REMOVED*** charset: s.scriptCharset, src: s.url ***REMOVED*** )
					.on( "load error", callback = function( evt ) ***REMOVED***
						script.remove();
						callback = null;
						if ( evt ) ***REMOVED***
