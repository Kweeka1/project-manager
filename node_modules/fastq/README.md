...
queue.push(42, function (err, result) ***REMOVED***
...
const that = ***REMOVED*** hello: 'world' ***REMOVED***
...
import type ***REMOVED*** queue, done ***REMOVED*** from "fastq";
...
q.push(***REMOVED*** id: 42***REMOVED***)

function worker (arg: Task, cb: done) ***REMOVED***
  console.log(arg.id)
  cb(null)
***REMOVED***
```
...
import * as fastq from "fastq";
import type ***REMOVED*** queueAsPromised ***REMOVED*** from "fastq";
...
q.push(***REMOVED*** id: 42***REMOVED***).catch((err) => console.error(err))

async function asyncWorker (arg: Task): Promise<void> ***REMOVED***
