...
gulp.task('app-js', function () ***REMOVED***
  return merge2(
      gulp.src('static/src/tpl/*.html')
        .pipe(minifyHtml(***REMOVED***empty: true***REMOVED***))
        .pipe(ngtemplate(***REMOVED***
          module: 'genTemplates',
          standalone: true
    ***REMOVED***)
      ), gulp.src([
...
```js
const stream = merge2([stream1, stream2], stream3, ***REMOVED***end: false***REMOVED***)
//...
...
### mergedStream.on('queueDrain', function() ***REMOVED******REMOVED***)
