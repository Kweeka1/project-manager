...
function makeDir(t, dir, cb) ***REMOVED***
    mkdirp(dir, function (err) ***REMOVED***
        if (err) ***REMOVED***
            cb(err);
    ***REMOVED*** else ***REMOVED***
            t.teardown(function cleanup() ***REMOVED***
                rimraf.sync(dir);
        ***REMOVED***);
            cb();
    ***REMOVED***
...
function makeTempDir(t, dir, cb) ***REMOVED***
    if (fs.existsSync(dir)) ***REMOVED***
        ...
        mv(dir, backup, function (err) ***REMOVED***
            if (err) ***REMOVED***
                cb(err);
        ***REMOVED*** else ***REMOVED***
                t.teardown(function () ***REMOVED***
                    mv(backup, dir, cb);
            ***REMOVED***);
                makeDir(t, dir, cb);
        ***REMOVED***
...
test('homedir module paths', function (t) ***REMOVED***
    t.plan(7);

    makeTempDir(t, hnm, function (err) ***REMOVED***
    ...
    ***REMOVED***
        ...
        var bazPkg = ***REMOVED*** name: 'baz', main: 'quux.js' ***REMOVED***;
        var dotMainPkg = ***REMOVED*** main: 'index' ***REMOVED***;
        ...
        makeTempDir(t, hnl, function (err) ***REMOVED***
        ...
        ***REMOVED***
            ...
            var dotSlashMainPkg = ***REMOVED*** main: 'index' ***REMOVED***;
            ...
            t.test('with temp dirs', function (st) ***REMOVED***
                st.plan(3);

                st.test('just in `$HOME/.node_modules`', function (s2t) ***REMOVED***
                    s2t.plan(3);

                    resolve('dot_main', function (err, res, pkg) ***REMOVED***
            ...
            ***REMOVED***);
                ...
                st.test('just in `$HOME/.node_libraries`', function (s2t) ***REMOVED***
                    s2t.plan(3);

                    resolve('dot_slash_main', function (err, res, pkg) ***REMOVED***
            ...
            ***REMOVED***);
                ...
                st.test('in `$HOME/.node_libraries` and `$HOME/.node_modules`', function (s2t) ***REMOVED***
                    s2t.plan(3);

                    resolve('baz', function (err, res, pkg) ***REMOVED***
