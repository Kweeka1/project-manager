...
test('filter', function (t) ***REMOVED***
    var dir = path.join(__dirname, 'resolver');
    var packageFilterArgs;
    var res = resolve.sync('./baz', ***REMOVED***
        basedir: dir,
        // NOTE: in v2.x, this will be `pkg, pkgfile, dir`, but must remain "broken" here in v1.x for compatibility
        packageFilter: function (pkg, /*pkgfile,*/ dir) ***REMOVED*** // eslint-disable-line spaced-comment
...
***REMOVED***);
    ...
    if (!'is 1.x') ***REMOVED*** // eslint-disable-line no-constant-condition
