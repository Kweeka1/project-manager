import ***REMOVED*** RangePosition ***REMOVED*** from './css-syntax-error.js'
import Node from './node.js'

export interface WarningOptions ***REMOVED***
  /**
 ...
 *
 * ```js
 * if (decl.important) ***REMOVED***
 *   decl.warn(result, 'Avoid !important', ***REMOVED*** word: '!important' ***REMOVED***)
 * ***REMOVED***
 * ```
 */
export default class Warning ***REMOVED***
  /**
