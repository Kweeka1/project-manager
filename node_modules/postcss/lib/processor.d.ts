 ...
 * ```
 */
export default class Processor ***REMOVED***
  /**
   * Current PostCSS version.
   *
   * ```js
   * if (result.processor.version.split('.')[0] !== '6') ***REMOVED***
   ...
   * * A function. PostCSS will pass the function a @***REMOVED***link Root***REMOVED***
   ...
   *
   * ```js
   * processor.process(css, ***REMOVED*** from: 'a.css', to: 'a.out.css' ***REMOVED***)
   *   .then(result => ***REMOVED***
   ...
   */
  process(
    css: string | ***REMOVED*** toString(): string ***REMOVED*** | Result | LazyResult | Root,
