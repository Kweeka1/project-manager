import ***REMOVED*** FilePosition ***REMOVED*** from './input.js'

/**
 * A position that is part of a range.
 */
export interface RangePosition ***REMOVED***
  /**
 ...
 * throw node.error('Unknown variable', ***REMOVED*** plugin: 'postcss-vars' ***REMOVED***)
 * ```
 *
 * ```js
 * // Catching and checking syntax error
 * try ***REMOVED***
 *   postcss.parse('a***REMOVED***')
 * ***REMOVED*** catch (error) ***REMOVED***
 *   if (error.name === 'CssSyntaxError') ***REMOVED***
 *     error //=> CssSyntaxError
 * ***REMOVED***
 * ***REMOVED***
 * ```
 */
export default class CssSyntaxError ***REMOVED***
  /**
   ...
   *
   * ```js
   * error.source       //=> 'a ***REMOVED*** b ***REMOVED******REMOVED*** ***REMOVED***'
   * error.input.source //=> 'a b ***REMOVED*** ***REMOVED***'
   * ```
   */
  source?: string
   ...
   *
   * ```js
   * error.showSourceCode() //=> "  4 | ***REMOVED***
   *                        //      5 | a ***REMOVED***
   *                        //    > 6 |   bad
   *                        //        |   ^
   *                        //      7 | ***REMOVED***
