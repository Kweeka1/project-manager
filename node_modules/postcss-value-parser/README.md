...
***REMOVED***
  nodes: [
    ***REMOVED***
      ...
      after: '',
      nodes: [
        ***REMOVED*** type: 'word', value: '233' ***REMOVED***,
        ***REMOVED*** type: 'div', value: ',', before: '', after: ' ' ***REMOVED***,
        ***REMOVED*** type: 'word', value: '45' ***REMOVED***,
        ***REMOVED*** type: 'div', value: ',', before: '', after: ' ' ***REMOVED***,
        ***REMOVED*** type: 'word', value: '66' ***REMOVED***,
        ***REMOVED*** type: 'div', value: ',', before: ' ', after: '' ***REMOVED***,
        ***REMOVED*** type: 'word', value: '.5' ***REMOVED***
      ]
***REMOVED***
  ]
***REMOVED***
...
parsed.walk(function (node) ***REMOVED***
  ...
  var color = node.nodes.filter(function (node) ***REMOVED***
    return node.type === 'word';
***REMOVED***).map(function (node) ***REMOVED***
...
[
  ***REMOVED***
    ...
    nodes: [
      ***REMOVED*** type: 'word', value: 'min-width' ***REMOVED***,
      ***REMOVED*** type: 'div', value: ':', before: '', after: ' ' ***REMOVED***,
      ***REMOVED*** type: 'word', value: '700px' ***REMOVED***
    ]
***REMOVED***
]
```
...
```js
***REMOVED*** type: 'function', sourceIndex: 0, value: 'url', before: ' ', after: ' ', nodes: [
    ***REMOVED*** type: 'word', sourceIndex: 5, value: '/gfx/img/bg.jpg' ***REMOVED***
] ***REMOVED***
```
...
```js
***REMOVED*** type: 'function', sourceIndex: 0, value: 'url', before: ' ', after: ' ', nodes: [
     type: 'string', sourceIndex: 5, quote: '"', value: '/gfx/img/bg.jpg' ***REMOVED***,
] ***REMOVED***
```
