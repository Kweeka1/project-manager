...
import ***REMOVED*** Plugin, ProcessOptions, Transformer ***REMOVED*** from 'postcss';
import ***REMOVED*** Options as ConfigOptions ***REMOVED*** from "lilconfig";
...
declare namespace postcssrc ***REMOVED***
  function sync(
    ctx?: ConfigContext,
    path?: string,
    options?: ConfigOptions
  ...
  export interface ProcessOptionsPreload ***REMOVED***
...
***REMOVED***
  ...
  export interface Context ***REMOVED***
    cwd?: string;
    env?: string;
***REMOVED***
  ...
  export interface Result ***REMOVED***
    file: string;
