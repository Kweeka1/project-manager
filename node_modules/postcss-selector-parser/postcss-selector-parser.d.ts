...
***REMOVED***
    interface ParserOptions ***REMOVED***
        css: string;
        error: (message: string, options: ErrorOptions) => Error;
        options: Options;
***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
***REMOVED***
    interface SpaceAround ***REMOVED***
      before: string;
      after: string;
***REMOVED***
    interface Spaces extends SpaceAround ***REMOVED***
      [spaceType: string]: string | Partial<SpaceAround> | undefined;
***REMOVED***
    interface NodeOptions<Value = string> ***REMOVED***
        value: Value;
...
***REMOVED***
    ...
    > ***REMOVED***
        ...
        next(): Node;
        prev(): Node;
        clone(opts: ***REMOVED***[override: string]:any***REMOVED***): Node;
        /**
        ...
        toString(): string;
***REMOVED***
    interface ContainerOptions extends NodeOptions ***REMOVED***
        nodes?: Array<Node>;
***REMOVED***
    interface Container<
        Value extends string | undefined = string,
        Child extends Node = Node
    > extends Base<Value> ***REMOVED***
        nodes: Array<Child>;
...
***REMOVED***
    ...
    interface NamespaceOptions<Value extends string | undefined = string> extends NodeOptions<Value> ***REMOVED***
        namespace?: string | true;
***REMOVED***
    interface Namespace<Value extends string | undefined = string> extends Base<Value> ***REMOVED***
        /** alias for namespace */
        ns: string | true;
        /**
         *  namespace prefix.
...
***REMOVED***
    ...
    interface Root extends Container<undefined, Selector> ***REMOVED***
        type: "root";
        /**
         * Raises an error, if the processor is invoked on
         * a postcss Rule node, a better error message is raised.
...
***REMOVED***
    ...
    interface _Selector<S> extends Container<string, Diff<Node, S>> ***REMOVED***
        type: "selector";
***REMOVED***
    ...
    interface CombinatorRaws ***REMOVED***
        value?: string;
        spaces?: ***REMOVED***
            before?: string;
            after?: string;
    ***REMOVED***;
***REMOVED***
    interface Combinator extends Base ***REMOVED***
        type: "combinator";
        raws?: CombinatorRaws;
***REMOVED***
    ...
    interface ClassName extends Base ***REMOVED***
        type: "class";
***REMOVED***
    ...
    type QuoteMark = '"' | "'" | null;
    interface PreferredQuoteMarkOptions ***REMOVED***
        quoteMark?: QuoteMark;
        preferCurrentQuoteMark?: boolean;
***REMOVED***
    interface SmartQuoteMarkOptions extends PreferredQuoteMarkOptions ***REMOVED***
        smart?: boolean;
***REMOVED***
    interface AttributeOptions extends NamespaceOptions<string | undefined> ***REMOVED***
        attribute: string;
    ...
    ***REMOVED***;
***REMOVED***
    interface Attribute extends Namespace<string | undefined> ***REMOVED***
        type: "attribute";
        attribute: string;
        operator?: AttributeOperator;
        insensitive?: boolean;
...
***REMOVED***
    ...
    interface Pseudo extends Container<string, Selector> ***REMOVED***
        type: "pseudo";
***REMOVED***
