...
```js
const transform = selectors => ***REMOVED***
    selectors.walkUniversals(selector => ***REMOVED***
        selector.remove();
***REMOVED***);
***REMOVED***;
...
```js
parser.attribute(***REMOVED***attribute: 'href'***REMOVED***);
// => [href]
```
...
```js
parser.className(***REMOVED***value: 'button'***REMOVED***);
// => .button
```
...
```js
parser.combinator(***REMOVED***value: '+'***REMOVED***);
// => +
```
...
```js
parser.comment(***REMOVED***value: '/* Affirmative, Dave. I read you. */'***REMOVED***);
...
```js
parser.id(***REMOVED***value: 'search'***REMOVED***);
// => #search
```
...
```js
parser.pseudo(***REMOVED***value: '::before'***REMOVED***);
// => ::before
```
...
```js
parser.tag(***REMOVED***value: 'button'***REMOVED***);
// => button
```
...
```js
parser.attribute(***REMOVED***attribute: 'href'***REMOVED***).type;
// => 'attribute'
```
...
```js
const id = parser.id(***REMOVED***value: 'search'***REMOVED***);
...
```js
const next = id.next();
if (next && next.type !== 'combinator') ***REMOVED***
...
const className = parser.className(***REMOVED***value: 'test'***REMOVED***);
...
```js
const cloned = parser.id(***REMOVED***value: 'search'***REMOVED***);
String(cloned);
...
```js
let className;
selectors.each((selector, index) => ***REMOVED***
    if (selector.type === 'class') ***REMOVED***
...
```js
selectors.walk((selector, index) => ***REMOVED***
    // all nodes
***REMOVED***);
```
...
```js
// (input) => h1 h2>>h3
const list = selectors.first.split(selector => ***REMOVED***
...
```js
selectors.walk(selector => ***REMOVED***
    if (selector.type !== 'class') ***REMOVED***
        const className = parser.className(***REMOVED***value: 'theme-name'***REMOVED***);
...
***REMOVED***
  ...
  spaces: ***REMOVED***
    before: '',
    after: '',
    attribute: ***REMOVED*** before: '  ', after: '  ' ***REMOVED***,
    operator: ***REMOVED*** after: '  ' ***REMOVED***,
    value: ***REMOVED*** after: ' ' ***REMOVED***,
    insensitive: ***REMOVED*** after: ' ' ***REMOVED***
***REMOVED***
  raws: ***REMOVED***
    spaces: ***REMOVED***
      attribute: ***REMOVED*** before: ' /*before*/ ', after: ' /* after-attr */ ' ***REMOVED***,
      operator: ***REMOVED*** after: ' /* after-operator */ ' ***REMOVED***,
      value: ***REMOVED*** after: '/* wow */ /*omg*/' ***REMOVED***,
      insensitive: ***REMOVED*** after: '/*bbq*/ /*whodoesthis*/' ***REMOVED***
***REMOVED***,
    unquoted: 'test',
...
let promise = processor.process(' .class').then(result => ***REMOVED***
    console.log(result)
    // => .class
***REMOVED***);

// To have the parser normalize whitespace values, utilize the options
result = processor.processSync('  .class  ', ***REMOVED***lossless: false***REMOVED***);
console.log(result);
// => .class

// For better syntax errors, pass a PostCSS Rule node.
const postcss = require('postcss');
rule = postcss.rule(***REMOVED***selector: ' #foo    > a,  .class  '***REMOVED***);
processor.process(rule, ***REMOVED***lossless: false, updateSelector: true***REMOVED***).then(result => ***REMOVED***
    console.log(result);
    // => #foo>a,.class
...
```js
let processor = (root) => ***REMOVED***
    return new Promise((resolve, reject) => ***REMOVED***
        root.walkClasses((classNode) => ***REMOVED***
            if (/^(.*)[-_]/.test(classNode.value)) ***REMOVED***
                let msg = "classes may not have underscores or dashes in them";
                reject(root.error(msg, ***REMOVED***
...
const plugin = postcss.plugin('classValidator', (options) => ***REMOVED***
    return (root) => ***REMOVED***
        let promises = [];
...
.foo-bar ***REMOVED***
  color: red;
***REMOVED***
`.trim(), ***REMOVED***from: 'test.css'***REMOVED***).catch((e) => console.error(e.toString()));
