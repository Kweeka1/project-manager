...
```js
const selectorParser = require("postcss-selector-parser");
let attr = selectorParser.attribute(***REMOVED***attribute: "id", operator: "=", value: "a-value"***REMOVED***);
attr.value; // => "a-value"
...
let className = selectorParser.className(***REMOVED***value: "illegal class name", raws: ***REMOVED***value: "illegal\\ class\\ name"***REMOVED******REMOVED***);
...
let attr = selectorParser.attribute(***REMOVED***attribute: "id", operator: "=", value: "a-value", quoteMark: null***REMOVED***);
attr.toString(); // => "[id=a-value]"
...
attr.setValue('a value \n that should be quoted', ***REMOVED***smart: true, preferCurrentQuoteMark: true, quoteMark: "'"***REMOVED***);
...
attr.setValue('this should be quoted', ***REMOVED***smart: true, preferCurrentQuoteMark: true, quoteMark: "'"***REMOVED***);
// => '[id="this should be quoted"]'

// picks single quotes because the value has double quotes
attr.setValue('a "double quoted" value', ***REMOVED***smart: true, preferCurrentQuoteMark: true, quoteMark: "'"***REMOVED***);
...
* Fixes misinterpretation of Sass interpolation (e.g. `#***REMOVED***foo***REMOVED***`) as an
