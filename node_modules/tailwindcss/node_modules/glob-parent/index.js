...
function isEnclosure(str) ***REMOVED***
  var lastChar = str.slice(-1);

  var enclosureStart;
  switch (lastChar) ***REMOVED***
    case '***REMOVED***':
      enclosureStart = '***REMOVED***';
      break;
    case ']':
      enclosureStart = '[';
      break;
...
function isGlobby(str) ***REMOVED***
  if (/\([^()]+$/.test(str)) ***REMOVED***
    return true;
***REMOVED***
  if (str[0] === '***REMOVED***' || str[0] === '[') ***REMOVED***
    return true;
***REMOVED***
  if (/[^\\][***REMOVED***[]/.test(str)) ***REMOVED***
    return true;
***REMOVED***
  return isGlob(str);
***REMOVED***
