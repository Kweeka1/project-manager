...
export default function normalizeTailwindDirectives(root) ***REMOVED***
...
***REMOVED***
    ...
    if (['layer', 'responsive', 'variants'].includes(atRule.name)) ***REMOVED***
      if (['responsive', 'variants'].includes(atRule.name)) ***REMOVED***
        log.warn(`$***REMOVED***atRule.name***REMOVED***-at-rule-deprecated`, [
...
***REMOVED***)
  ...
  if (
    ...
    for (let rule of layerDirectives) ***REMOVED***
      if (rule.name === 'layer' && ['base', 'components', 'utilities'].includes(rule.params)) ***REMOVED***
        if (!tailwindDirectives.has(rule.params)) ***REMOVED***
          throw rule.error(
            `\`@layer $***REMOVED***rule.params***REMOVED***\` is used but no matching \`@tailwind $***REMOVED***rule.params***REMOVED***\` directive is present.`
          )
    ***REMOVED***
...
***REMOVED***
  ...
  return ***REMOVED*** tailwindDirectives, applyDirectives ***REMOVED***
***REMOVED***
