...
export default function parseAnimationValue(input) ***REMOVED***
  let animations = input.split(COMMA)
  return animations.map((animation) => ***REMOVED***
    let value = animation.trim()
    let result = ***REMOVED*** value ***REMOVED***
  ...
  ***REMOVED*** else if (!seen.has('TIMING_FUNCTION') && TIMING_FNS.some((f) => part.startsWith(`$***REMOVED***f***REMOVED***(`))) ***REMOVED***
        result.timingFunction = part
        seen.add('TIMING_FUNCTION')
