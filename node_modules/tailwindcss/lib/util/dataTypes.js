...
;
function normalize(value, isRoot = true) ***REMOVED***
    // Keep raw strings if it starts with `url(`
    if (value.includes("url(")) ***REMOVED***
        return value.split(/(url\(.*?\))/g).filter(Boolean).map((part)=>***REMOVED***
...
function length(value) ***REMOVED***
    return value.split(UNDERSCORE).every((part)=>***REMOVED***
        return part === "0" || new RegExp(`$***REMOVED***lengthUnitsPattern***REMOVED***$`).test(part) || cssFunctions.some((fn)=>new RegExp(`^$***REMOVED***fn***REMOVED***\\(.+?$***REMOVED***lengthUnitsPattern***REMOVED***`).test(part)
        );
***REMOVED***);
***REMOVED***
...
function lineWidth(value) ***REMOVED***
    return lineWidths.has(value);
***REMOVED***
function shadow(value) ***REMOVED***
...
function gradient(value) ***REMOVED***
...
function position(value) ***REMOVED***
    let positions = 0;
    let result = value.split(UNDERSCORE).every((part)=>***REMOVED***
        part = normalize(part);
        if (part.startsWith("var(")) return true;
...
***REMOVED***);
    ...
    return positions > 0;
***REMOVED***
function familyName(value) ***REMOVED***
    let fonts = 0;
    let result = value.split(COMMA).every((part)=>***REMOVED***
        part = normalize(part);
        if (part.startsWith("var(")) return true;
...
function genericName(value) ***REMOVED***
...
function absoluteSize(value) ***REMOVED***
...
function relativeSize(value) ***REMOVED***
