...
function list(items) ***REMOVED***
    return items.map((key)=>`'$***REMOVED***key***REMOVED***'`
    ).join(", ");
***REMOVED***
...
function validatePath(config, path, defaultValue) ***REMOVED***
    ...
    if (value === undefined) ***REMOVED***
        ...
        if (isObject(parentValue)) ***REMOVED***
            ...
            if (suggestion) ***REMOVED***
                error += ` Did you mean '$***REMOVED***pathToString([
                    ...parentSegments,
                    suggestion
                ])***REMOVED***'?`;
        ***REMOVED*** else if (validKeys.length > 0) ***REMOVED***
                error += ` '$***REMOVED***pathToString(parentSegments)***REMOVED***' has the following valid keys: $***REMOVED***list(validKeys)***REMOVED***`;
        ***REMOVED***
    ***REMOVED*** else ***REMOVED***
            ...
            if (closestPath) ***REMOVED***
                ...
                if (isObject(closestValue)) ***REMOVED***
                    error += ` '$***REMOVED***pathToString(closestPath)***REMOVED***' has the following keys: $***REMOVED***listKeys(closestValue)***REMOVED***`;
            ***REMOVED*** else ***REMOVED***
    ...
    ***REMOVED***;
***REMOVED***
    if (!(typeof value === "string" || typeof value === "number" || typeof value === "function" || value instanceof String || value instanceof Number || Array.isArray(value))) ***REMOVED***
        ...
        if (isObject(value)) ***REMOVED***
            ...
            if (validKeys.length) ***REMOVED***
                error += ` Did you mean something like '$***REMOVED***pathToString([
                    ...pathSegments,
                    validKeys[0]
                ])***REMOVED***'?`;
        ***REMOVED***
...
function extractArgs(node, vNodes, functions) ***REMOVED***
    ...
    for (let vNode1 of vNodes)***REMOVED***
        if (vNode1.type === "div" && vNode1.value === ",") ***REMOVED***
            args.push("");
    ***REMOVED*** else ***REMOVED***
...
function resolveFunctions(node, input, functions) ***REMOVED***
    return (0, _postcssValueParser).default(input).walk((vNode)=>***REMOVED***
...
let nodeTypePropertyMap = ***REMOVED***
    ...
    decl: "value"
***REMOVED***;
function _default(***REMOVED*** tailwindConfig: config***REMOVED***) ***REMOVED***
    let functions = ***REMOVED***
        theme: (node, path, ...defaultValue)=>***REMOVED***
            const ***REMOVED*** isValid , value , error***REMOVED*** = validatePath(config, path, defaultValue.length ? defaultValue : undefined);
            if (!isValid) ***REMOVED***
