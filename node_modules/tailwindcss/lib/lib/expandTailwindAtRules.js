...
function expandTailwindAtRules(context) ***REMOVED***
    return (root)=>***REMOVED***
    ...
    ***REMOVED***
        ...
        let ***REMOVED*** defaults: defaultNodes , base: baseNodes , components: componentNodes , utilities: utilityNodes , variants: screenNodes ,***REMOVED*** = context.stylesheetCache;
        // ---
        ...
        if (layerNodes.base) ***REMOVED***
            layerNodes.base.before((0, _cloneNodes).default([
                ...baseNodes,
                ...defaultNodes
            ], layerNodes.base.source, ***REMOVED***
                layer: "base"
        ***REMOVED***));
    ...
    ***REMOVED***
        if (layerNodes.components) ***REMOVED***
            layerNodes.components.before((0, _cloneNodes).default([
                ...componentNodes
            ], layerNodes.components.source, ***REMOVED***
                layer: "components"
        ***REMOVED***));
    ...
    ***REMOVED***
        if (layerNodes.utilities) ***REMOVED***
            layerNodes.utilities.before((0, _cloneNodes).default([
                ...utilityNodes
            ], layerNodes.utilities.source, ***REMOVED***
                layer: "utilities"
        ***REMOVED***));
    ...
    ***REMOVED***);
        if (layerNodes.variants) ***REMOVED***
            layerNodes.variants.before((0, _cloneNodes).default(variantNodes, layerNodes.variants.source, ***REMOVED***
                layer: "variants"
        ***REMOVED***));
            layerNodes.variants.remove();
    ***REMOVED*** else if (variantNodes.length > 0) ***REMOVED***
            root.append((0, _cloneNodes).default(variantNodes, root.source, ***REMOVED***
                layer: "variants"
        ***REMOVED***));
    ***REMOVED***
        // If we've got a utility layer and no utilities are generated there's likely something wrong
        const hasUtilityVariants = variantNodes.some((node)=>***REMOVED***
            var ref;
...
function getClassCandidates(content, extractor, candidates, seen) ***REMOVED***
    if (!extractorCache.has(extractor)) ***REMOVED***
        extractorCache.set(extractor, new _quickLru.default(***REMOVED***
            maxSize: 25000
    ***REMOVED***));
***REMOVED***
