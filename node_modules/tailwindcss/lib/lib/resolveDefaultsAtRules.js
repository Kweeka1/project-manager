...
function resolveDefaultsAtRules(***REMOVED*** tailwindConfig***REMOVED***) ***REMOVED***
    return (root)=>***REMOVED***
        let variableNodeMap = new Map();
        /** @type ***REMOVED***Set<import('postcss').AtRule>***REMOVED*** */ let universals = new Set();
    ...
    ***REMOVED***);
        for (let universal of universals)***REMOVED***
            /** @type ***REMOVED***Map<string, Set<string>>***REMOVED*** */ let selectorGroups = new Map();
            var ref;
            ...
            ***REMOVED***
        ***REMOVED***
            if ((0, _featureFlags).flagEnabled(tailwindConfig, "optimizeUniversalDefaults")) ***REMOVED***
                if (selectorGroups.size === 0) ***REMOVED***
                    universal.remove();
                    continue;
            ***REMOVED***
                for (let [, selectors] of selectorGroups)***REMOVED***
                    let universalRule = _postcss.default.rule(***REMOVED***
...
let getNode = ***REMOVED***
    id (node) ***REMOVED***
        return _postcssSelectorParser.default.attribute(***REMOVED***
            attribute: "id",
            operator: "=",
            value: node.value,
            quoteMark: '"'
...
function minimumImpactSelector(nodes) ***REMOVED***
    let rest = nodes.filter((node)=>***REMOVED***
...
***REMOVED***
let elementSelectorParser = (0, _postcssSelectorParser).default((selectors)=>***REMOVED***
