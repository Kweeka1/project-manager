...
function parseVariantFormatString(input) ***REMOVED***
    if (input.includes("***REMOVED***")) ***REMOVED***
        ...
        return input.split(/***REMOVED***(.*)***REMOVED***/gim).flatMap((line)=>parseVariantFormatString(line)
        ).filter(Boolean);
***REMOVED***
    return [
        input.trim()
...
***REMOVED***
function extractCandidates(node, state = ***REMOVED***
    containsNonOnDemandable: false
***REMOVED***, depth = 0) ***REMOVED***
    let classes = [];
    // Handle normal rules
            ...
            variantFunctions = [].concat(variantFunctions).map((variantFunction)=>***REMOVED***
                if (typeof variantFunction !== "string") ***REMOVED***
                    ...
                    return (***REMOVED*** modifySelectors , container , separator***REMOVED***)=>***REMOVED***
                        return variantFunction(***REMOVED***
                            modifySelectors,
                            container,
                            separator
                    ***REMOVED***);
                ***REMOVED***;
            ***REMOVED***
                variantFunction = variantFunction.replace(/\n+/g, "").replace(/\s***REMOVED***1,***REMOVED***/g, " ").trim();
                let fns = parseVariantFormatString(variantFunction).map((str)=>***REMOVED***
                    if (!str.startsWith("@")) ***REMOVED***
                        return (***REMOVED*** format***REMOVED***)=>format(str)
                        ;
                ***REMOVED***
                    let [, name, params] = /@(.*?) (.*)/g.exec(str);
                    return (***REMOVED*** wrap***REMOVED***)=>wrap(_postcss.default.atRule(***REMOVED***
                            name,
                            params
                    ***REMOVED***))
                    ;
            ...
            for(let identifier in utilities)***REMOVED***
                ...
                ***REMOVED***
                    if (!(0, _isValidArbitraryValue).default(value)) ***REMOVED***
                        return [];
                ***REMOVED***
                    let ruleSets = [].concat(rule(value)).filter(Boolean).map((declaration)=>(***REMOVED***
                    ...
                    if (!type.includes(coercedType)) ***REMOVED***
                        if (isOnlyPlugin) ***REMOVED***
                            _log.default.warn([
                                ...
                                `You can safely update it to \`$***REMOVED***identifier***REMOVED***-$***REMOVED***modifier.replace(coercedType + ":", "")***REMOVED***\`.`, 
                            ]);
                    ***REMOVED*** else ***REMOVED***
                            return [];
                    ***REMOVED***
...
function getFileModifiedMap(context) ***REMOVED***
...
function trackModified(files, fileModifiedMap) ***REMOVED***
    ...
    for (let file of files)***REMOVED***
        ...
        let newModified = (ref = _fs.default.statSync(decodeURIComponent(pathname), ***REMOVED***
            throwIfNoEntry: false
    ***REMOVED***)) === null || ref === void 0 ? void 0 : ref.mtimeMs;
...
function resolvePlugins(context, root) ***REMOVED***
    let corePluginList = Object.entries(***REMOVED***
        ..._corePlugins.variantPlugins,
        ..._corePlugins.corePlugins
***REMOVED***).map(([name, plugin])=>***REMOVED***
...
***REMOVED***;
    reservedBits += 5n;
    let offset = 0;
    context.variantOrder = new Map(variantList.map((variant, i)=>***REMOVED***
...
***REMOVED***).sort(([, a], [, z])=>(0, _bigSign).default(a - z)
    ));
    context.minimumScreen = [
        ...context.variantOrder.values()
    ].shift();
    // Build variantMap
    for (let [variantName, variantFunctions1] of variantMap.entries())***REMOVED***
...
***REMOVED***
    ...
    if (safelist.length > 0) ***REMOVED***
        let checks = [];
        for (let value1 of safelist)***REMOVED***
            if (typeof value1 === "string") ***REMOVED***
            ...
            ***REMOVED***);
                continue;
        ***REMOVED***
            if (value1 instanceof RegExp) ***REMOVED***
    ...
    ***REMOVED***
        if (checks.length > 0) ***REMOVED***
            ...
            for (let util of classList)***REMOVED***
                let utils = Array.isArray(util) ? (()=>***REMOVED***
                    let [utilName, options] = util;
                    var ref;
                    let values = Object.keys((ref = options === null || options === void 0 ? void 0 : options.values) !== null && ref !== void 0 ? ref : ***REMOVED******REMOVED***);
                    let classes = values.map((value)=>(0, _nameClass).formatClass(utilName, value)
                    );
                    if (options === null || options === void 0 ? void 0 : options.supportsNegativeValues) ***REMOVED***
            ...
            ***REMOVED***)() : [
                ...
                for (let util1 of utils)***REMOVED***
...
***REMOVED***
    ...
    context.getClassOrder = function getClassOrder(classes) ***REMOVED***
        ...
        for (let [sort, rule] of (0, _generateRules).generateRules(new Set(classes), context))***REMOVED***
    ...
    context.getClassList = function getClassList() ***REMOVED***
        ...
        for (let util of classList)***REMOVED***
            if (Array.isArray(util)) ***REMOVED***
                ...
                let negativeClasses = [];
                var ref;
                for (let [key, value] of Object.entries((ref = options === null || options === void 0 ? void 0 : options.values) !== null && ref !== void 0 ? ref : ***REMOVED******REMOVED***))***REMOVED***
                    output.push((0, _nameClass).formatClass(utilName, key));
                    if ((options === null || options === void 0 ? void 0 : options.supportsNegativeValues) && (0, _negateValue).default(value)) ***REMOVED***
                        negativeClasses.push((0, _nameClass).formatClass(utilName, `-$***REMOVED***key***REMOVED***`));
                ***REMOVED***
            ***REMOVED***
...
***REMOVED***;
***REMOVED***
function createContext(tailwindConfig, changedContent = [], root = _postcss.default.root()) ***REMOVED***
    let context = ***REMOVED***
        disposables: [],
        ruleCache: new Set(),
        classCache: new Map(),
...
function getContext(root, result, tailwindConfig, userConfigPath, tailwindConfigHash, contextDependencies) ***REMOVED***
