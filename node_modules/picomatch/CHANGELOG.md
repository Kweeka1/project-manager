...
* Fixes bug when a pattern containing an expression after the closing parenthesis (`/!(*.d).***REMOVED***ts,tsx***REMOVED***`) was incorrectly converted to regexp ([9f241ef](https://github.com/micromatch/picomatch/commit/9f241ef)).
