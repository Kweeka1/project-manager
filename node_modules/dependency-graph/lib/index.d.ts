declare module 'dependency-graph' ***REMOVED***
  export interface Options ***REMOVED***
    circular?: boolean;
***REMOVED***

  export class DepGraph<T> ***REMOVED***
    /**
     ...
     * @param ***REMOVED***string***REMOVED*** name
     * @param ***REMOVED***boolean***REMOVED*** leavesOnly
     */
...
***REMOVED***
  ...
  export class DepGraphCycleError extends Error ***REMOVED***
    cyclePath: string[];
***REMOVED***
***REMOVED***
