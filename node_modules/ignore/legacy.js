...
var RETURN_FALSE = function RETURN_FALSE() ***REMOVED***
  return false;
***REMOVED***; // Sanitize the range of a regular expression
...
var sanitizeRange = function sanitizeRange(range) ***REMOVED***
  return range.replace(REGEX_REGEXP_RANGE, function (match, from, to) ***REMOVED***
    ...
    : EMPTY;
***REMOVED***);
***REMOVED***; // See fixtures #59


var cleanRangeBackSlash = function cleanRangeBackSlash(slashes) ***REMOVED***
...
function (_, p1) ***REMOVED***
  return "".concat(p1, "[^\\/]*");
***REMOVED***], [// unescape, revert step 3 except for back slash
// For example, if a user escape a '\\*',
// after step 3, the result will be '\\\\\\*'
/\\\\\\(?=[$.|*+()***REMOVED***^])/g, function () ***REMOVED***
  return ESCAPE;
***REMOVED***], [// '\\\\' -> '\\'
/\\\\/g, function () ***REMOVED***
  return ESCAPE;
***REMOVED***], [// > The range notation, e.g. [a-zA-Z],
// > can be used to match one of the characters in a range.
// `\` is escaped by step 3
/(\\)?\[([^\]/]*?)(\\*)($|\])/g, function (match, leadEscape, range, endEscape, close) ***REMOVED***
...
var makeRegex = function makeRegex(pattern, ignoreCase) ***REMOVED***
  var source = regexCache[pattern];

  if (!source) ***REMOVED***
    source = REPLACERS.reduce(function (prev, current) ***REMOVED***
...
***REMOVED*** // We don't know if we should ignore EMPTY, so throw
...
var Ignore = /*#__PURE__*/function () ***REMOVED***
