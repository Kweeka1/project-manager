...
- `***REMOVED***ignored: true, unignored: false***REMOVED***`: the `pathname` is ignored
- `***REMOVED***ignored: false, unignored: true***REMOVED***`: the `pathname` is unignored
- `***REMOVED***ignored: false, unignored: false***REMOVED***`: the `pathname` is never matched by any ignore rules.
...
.test(pathname: Pathname): ***REMOVED***ignored: boolean, unignored: boolean***REMOVED***
```
...
```js
import ***REMOVED***isPathValid***REMOVED*** from 'ignore' // introduced in 5.0.0
