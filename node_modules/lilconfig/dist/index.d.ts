export declare type LilconfigResult = null | ***REMOVED***
    filepath: string;
    config: any;
    isEmpty?: boolean;
***REMOVED***;
interface OptionsBase ***REMOVED***
    stopDir?: string;
    searchPlaces?: string[];
...
export interface Options extends OptionsBase ***REMOVED***
    loaders?: Loaders;
    transform?: Transform;
***REMOVED***
export interface OptionsSync extends OptionsBase ***REMOVED***
    loaders?: LoadersSync;
    transform?: TransformSync;
***REMOVED***
export declare const defaultLoaders: LoadersSync;
declare type AsyncSearcher = ***REMOVED***
...
declare type SyncSearcher = ***REMOVED***
