...
if (typeof process.chdir === 'function') ***REMOVED***
...
***REMOVED***
  ...
  if (platform === "win32") ***REMOVED***
    ...
    : (function (fs$rename) ***REMOVED***
      function rename (from, to, cb) ***REMOVED***
        var start = Date.now()
        var backoff = 0;
...
***REMOVED***
  ...
  : (function (fs$read) ***REMOVED***
    function read (fd, buffer, offset, length, position, callback_) ***REMOVED***
      var callback
...
***REMOVED***)(fs.read)
  ...
  : (function (fs$readSync) ***REMOVED*** return function (fd, buffer, offset, length, position) ***REMOVED***
    var eagCounter = 0
    while (true) ***REMOVED***
      try ***REMOVED***
...
***REMOVED***
  ...
  function patchLutimes (fs) ***REMOVED***
    if (constants.hasOwnProperty("O_SYMLINK") && fs.futimes) ***REMOVED***
...
***REMOVED*** else if (fs.futimes) ***REMOVED***
...
***REMOVED***
  ...
  function statFix (orig) ***REMOVED***
    ...
    // uid + gid.
    return function (target, options, cb) ***REMOVED***
      if (typeof options === 'function') ***REMOVED***
        cb = options
        options = null
  ***REMOVED***
      function callback (er, stats) ***REMOVED***
        if (stats) ***REMOVED***
...
***REMOVED***
  ...
  function statFixSync (orig) ***REMOVED***
    ...
    // Older versions of Node erroneously returned signed integers for
    // uid + gid.
    return function (target, options) ***REMOVED***
