...
function simple(node, visitors, baseVisitor, state, override) ***REMOVED***
  if (!baseVisitor) ***REMOVED*** baseVisitor = base
...
function ancestor(node, visitors, baseVisitor, state, override) ***REMOVED***
  var ancestors = [];
  if (!baseVisitor) ***REMOVED*** baseVisitor = base
  ; ***REMOVED***(function c(node, st, override) ***REMOVED***
    var type = override || node.type, found = visitors[type];
...
// nodes).
function recursive(node, state, funcs, baseVisitor, override) ***REMOVED***
...
function full(node, callback, baseVisitor, state, override) ***REMOVED***
  if (!baseVisitor) ***REMOVED*** baseVisitor = base
  ; ***REMOVED***(function c(node, st, override) ***REMOVED***
...
function fullAncestor(node, callback, baseVisitor, state) ***REMOVED***
  if (!baseVisitor) ***REMOVED*** baseVisitor = base; ***REMOVED***
  var ancestors = []
  ;(function c(node, st, override) ***REMOVED***
    var type = override || node.type;
    var isNew = node !== ancestors[ancestors.length - 1];
...
function findNodeAt(node, start, end, test, baseVisitor, state) ***REMOVED***
  if (!baseVisitor) ***REMOVED*** baseVisitor = base; ***REMOVED***
  test = makeTest(test);
  try ***REMOVED***
    (function c(node, st, override) ***REMOVED***
      ...
      if ((start == null || node.start <= start) &&
        ...
        ***REMOVED*** baseVisitor[type](node, st, c); ***REMOVED***
      if ((start == null || node.start === start) &&
          (end == null || node.end === end) &&
          test(type, node))
...
function findNodeAround(node, pos, test, baseVisitor, state) ***REMOVED***
  test = makeTest(test);
  if (!baseVisitor) ***REMOVED*** baseVisitor = base; ***REMOVED***
  try ***REMOVED***
    (function c(node, st, override) ***REMOVED***
...
function findNodeAfter(node, pos, test, baseVisitor, state) ***REMOVED***
  test = makeTest(test);
  if (!baseVisitor) ***REMOVED*** baseVisitor = base; ***REMOVED***
  try ***REMOVED***
    (function c(node, st, override) ***REMOVED***
...
function findNodeBefore(node, pos, test, baseVisitor, state) ***REMOVED***
  test = makeTest(test);
  if (!baseVisitor) ***REMOVED*** baseVisitor = base; ***REMOVED***
  var max
  ;(function c(node, st, override) ***REMOVED***
...
function make(funcs, baseVisitor) ***REMOVED***
...
base.SwitchStatement = function (node, st, c) ***REMOVED***
  ...
  for (var i$1 = 0, list$1 = node.cases; i$1 < list$1.length; i$1 += 1) ***REMOVED***
    var cs = list$1[i$1];
...
base.CatchClause = function (node, st, c) ***REMOVED***
  if (node.param) ***REMOVED*** c(node.param, st, "Pattern"); ***REMOVED***
  c(node.body, st, "Statement");
***REMOVED***;
...
base.ObjectPattern = function (node, st, c) ***REMOVED***
  for (var i = 0, list = node.properties; i < list.length; i += 1) ***REMOVED***
    ...
    if (prop.type === "Property") ***REMOVED***
      if (prop.computed) ***REMOVED*** c(prop.key, st, "Expression"); ***REMOVED***
      c(prop.value, st, "Pattern");
***REMOVED*** else if (prop.type === "RestElement") ***REMOVED***
...
base.SequenceExpression = function (node, st, c) ***REMOVED***
...
***REMOVED***
***REMOVED***;
base.TemplateLiteral = function (node, st, c) ***REMOVED***
...
base.ExportAllDeclaration = function (node, st, c) ***REMOVED***
  if (node.exported)
    ***REMOVED*** c(node.exported, st); ***REMOVED***
...
***REMOVED***
  c(node.source, st, "Expression");
***REMOVED***;
base.ImportExpression = function (node, st, c) ***REMOVED***
  c(node.source, st, "Expression");
***REMOVED***;
...
base.Class = function (node, st, c) ***REMOVED***
  ...
  c(node.body, st);
***REMOVED***;
base.ClassBody = function (node, st, c) ***REMOVED***
  for (var i = 0, list = node.body; i < list.length; i += 1)
    ***REMOVED***
    var elt = list[i];
...
export ***REMOVED*** ancestor, base, findNodeAfter, findNodeAround, findNodeAt, findNodeBefore, full, fullAncestor, make, recursive, simple ***REMOVED***;
