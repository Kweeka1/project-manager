...
```
var input = 'insargrm';
var list = [ ***REMOVED*** id: 'facebook' ***REMOVED***, ***REMOVED*** id: 'twitter' ***REMOVED***, ***REMOVED*** id: 'instagram' ***REMOVED***, ***REMOVED*** id: 'linkedin' ***REMOVED*** ];
var key = 'id';
...
(function() ***REMOVED***
  ...
  function didYouMean(str, list, key) ***REMOVED***
    if (!str) return null;

    // If we're running a case-insensitive search, smallify str.
    if (!didYouMean.caseSensitive) ***REMOVED*** str = str.toLowerCase(); ***REMOVED***
    ...
    for (i = 0; i < len; i++) ***REMOVED***
      ...
      if (key) ***REMOVED*** candidate = candidate[key]; ***REMOVED***
      // Gatekeep.
      if (!candidate) ***REMOVED*** continue; ***REMOVED***
      // If we're running a case-insensitive search, smallify the candidate.
      if (!didYouMean.caseSensitive) ***REMOVED*** testCandidate = candidate.toLowerCase(); ***REMOVED***
      else ***REMOVED*** testCandidate = candidate; ***REMOVED***
      ...
      if (winningVal === null || val < winningVal) ***REMOVED***
        winningVal = val;
...
***REMOVED***
  ...
  function getEditDistance(a, b, max) ***REMOVED***
    ...
    for (i = 0; i <= lenb; i++) ***REMOVED*** matrix[i] = [i]; ***REMOVED***

    // Set up the first column (same).
    for (j = 0; j <= lena; j++) ***REMOVED*** matrix[0][j] = j; ***REMOVED***

    // Loop over the rest of the columns.
    for (i = 1; i <= lenb; i++) ***REMOVED***
      colMin = MAX_INT;
      minJ = 1;
      if (i > max) minJ = i - max;
      maxJ = lenb + 1;
      ...
      for (j = 1; j <= lena; j++) ***REMOVED***
        // If j is out of bounds, just put a large value in the slot.
        if (j < minJ || j > maxJ) ***REMOVED***
          matrix[i][j] = max + 1;
    ***REMOVED***
