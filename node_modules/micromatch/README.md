...
* `list` *****REMOVED***String|Array<string>***REMOVED*****: List of strings to match.
* `patterns` *****REMOVED***String|Array<string>***REMOVED*****: One or more glob patterns to use for matching.
* `options` *****REMOVED***Object***REMOVED*****: See available [options](#options)
...
* `str` *****REMOVED***String***REMOVED*****: The string to test.
...
* `options` *****REMOVED***Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` *****REMOVED***Boolean***REMOVED*****: Returns true if any of the patterns matches any part of `str`.
...
* `patterns` *****REMOVED***String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` *****REMOVED***Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` *****REMOVED***Boolean***REMOVED*****: Returns true if any `patterns` matches any of the strings in `list`
...
* `patterns` *****REMOVED***String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` *****REMOVED***Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` *****REMOVED***Boolean***REMOVED*****: Returns true if all `patterns` matches all of the strings in `list`
...
* `glob` *****REMOVED***String***REMOVED*****: Glob pattern to use for matching.
* `input` *****REMOVED***String***REMOVED*****: String to match
* `options` *****REMOVED***Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` *****REMOVED***Array|null***REMOVED*****: Returns an array of captures if the input matches the glob pattern, otherwise `null`.
...
* `glob` *****REMOVED***String***REMOVED*****
* `options` *****REMOVED***Object***REMOVED*****
* `returns` *****REMOVED***Object***REMOVED*****: Returns an object with useful properties and output to be used as regex source string.
...
* `pattern` *****REMOVED***String***REMOVED*****: String with brace pattern to process.
...
micromatch(['a/b.js', 'a/c.md'], '*.js', ***REMOVED*** basename: true ***REMOVED***);
//=> ['a/b.js']
```
...
console.log(micromatch(files, '[a-c]*', ***REMOVED*** bash: false ***REMOVED***));
```
...
const regex = micromatch.makeRe('foo/***REMOVED***01..25***REMOVED***/bar', ***REMOVED***
...
```js
const isMatch = micromatch.matcher('*', ***REMOVED*** ignore: 'f*' ***REMOVED***);
...
console.log(micromatch(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)', ***REMOVED*** noextglob: true ***REMOVED***));
...
micromatch(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**', ***REMOVED***noglobstar: true***REMOVED***);
//=> ['a/b']
```
...
const onIgnore = (***REMOVED*** glob, regex, input, output ***REMOVED***) => ***REMOVED***
  ...
  // ***REMOVED*** glob: '*', regex: /^(?:(?!\.)(?=.)[^\/]*?\/?)$/, input: 'foo', output: 'foo' ***REMOVED***
***REMOVED***;

const isMatch = micromatch.matcher('*', ***REMOVED*** onIgnore, ignore: 'f*' ***REMOVED***);
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
const onMatch = (***REMOVED*** glob, regex, input, output ***REMOVED***) => ***REMOVED***
  console.log(***REMOVED*** input, output ***REMOVED***);
  // ***REMOVED*** input: 'some\\path', output: 'some/path' ***REMOVED***
  // ***REMOVED*** input: 'some\\path', output: 'some/path' ***REMOVED***
  // ***REMOVED*** input: 'some\\path', output: 'some/path' ***REMOVED***
***REMOVED***;

const isMatch = micromatch.matcher('**', ***REMOVED*** onMatch, posixSlashes: true ***REMOVED***);
isMatch('some\\path');
isMatch('some\\path');
isMatch('some\\path');
```
...
const isMatch = micromatch('*', ***REMOVED*** onResult, ignore: 'f*' ***REMOVED***);
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
console.log(micromatch.match(['a\\b\\c'], ***REMOVED*** posixSlashes: false ***REMOVED***));
//=> ['a\\b\\c']
```
...
console.log(micromatch.match(['abc', 'a\\*c'], 'a\\*c', ***REMOVED*** unescape: true ***REMOVED***));
//=> ['a*c']
```
...
The pattern `***REMOVED***f,b***REMOVED****/***REMOVED***1..3***REMOVED***/***REMOVED***b,q***REMOVED****` would match any of following strings:
