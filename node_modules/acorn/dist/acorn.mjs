...
***REMOVED***
var beforeExpr = ***REMOVED***beforeExpr: true***REMOVED***, startsExpr = ***REMOVED***startsExpr: true***REMOVED***;
...
function isNewLine(code, ecma2019String) ***REMOVED***
...
function wordsRegexp(words) ***REMOVED***
...
function functionFlags(async, generator) ***REMOVED***
...
var Parser = function Parser(options, input, startPos) ***REMOVED***
  ...
  var reserved = "";
  if (options.allowReserved !== true) ***REMOVED***
...
***REMOVED***
  ...
  this.undefinedExports = ***REMOVED******REMOVED***;
...
var prototypeAccessors = ***REMOVED*** inFunction: ***REMOVED*** configurable: true ***REMOVED***,inGenerator: ***REMOVED*** configurable: true ***REMOVED***,inAsync: ***REMOVED*** configurable: true ***REMOVED***,allowSuper: ***REMOVED*** configurable: true ***REMOVED***,allowDirectSuper: ***REMOVED*** configurable: true ***REMOVED***,treatFunctionsAsVar: ***REMOVED*** configurable: true ***REMOVED*** ***REMOVED***;
...
prototypeAccessors.inFunction.get = function () ***REMOVED*** return (this.currentVarScope().flags & SCOPE_FUNCTION) > 0 ***REMOVED***;
prototypeAccessors.inGenerator.get = function () ***REMOVED*** return (this.currentVarScope().flags & SCOPE_GENERATOR) > 0 ***REMOVED***;
prototypeAccessors.inAsync.get = function () ***REMOVED*** return (this.currentVarScope().flags & SCOPE_ASYNC) > 0 ***REMOVED***;
prototypeAccessors.allowSuper.get = function () ***REMOVED*** return (this.currentThisScope().flags & SCOPE_SUPER) > 0 ***REMOVED***;
prototypeAccessors.allowDirectSuper.get = function () ***REMOVED*** return (this.currentThisScope().flags & SCOPE_DIRECT_SUPER) > 0 ***REMOVED***;
prototypeAccessors.treatFunctionsAsVar.get = function () ***REMOVED*** return this.treatFunctionsAsVarInScope(this.currentScope()) ***REMOVED***;

// Switch to a getter for 7.0.0.
Parser.prototype.inNonArrowFunction = function inNonArrowFunction () ***REMOVED*** return (this.currentThisScope().flags & SCOPE_FUNCTION) > 0 ***REMOVED***;

Parser.extend = function extend () ***REMOVED***
    var plugins = [], len = arguments.length;
    while ( len-- ) plugins[ len ] = arguments[ len ];

  var cls = this;
  for (var i = 0; i < plugins.length; i++) ***REMOVED*** cls = plugins[i](cls); ***REMOVED***
  return cls
***REMOVED***;

Parser.parse = function parse (input, options) ***REMOVED***
  return new this(options, input).parse()
***REMOVED***;

Parser.parseExpressionAt = function parseExpressionAt (input, pos, options) ***REMOVED***
  var parser = new this(options, input, pos);
  parser.nextToken();
  return parser.parseExpression()
***REMOVED***;

Parser.tokenizer = function tokenizer (input, options) ***REMOVED***
...
pp.strictDirective = function(start) ***REMOVED***
  for (;;) ***REMOVED***
    ...
    if ((match[1] || match[2]) === "use strict") ***REMOVED***
      skipWhiteSpace.lastIndex = start + match[0].length;
      var spaceAfter = skipWhiteSpace.exec(this.input), end = spaceAfter.index + spaceAfter[0].length;
      var next = this.input.charAt(end);
      return next === ";" || next === "***REMOVED***" ||
...
***REMOVED***
  if (this.inModule)
    ***REMOVED*** for (var i = 0, list = Object.keys(this.undefinedExports); i < list.length; i += 1)
      ***REMOVED***
        var name = list[i];
...
var loopLabel = ***REMOVED***kind: "loop"***REMOVED***, switchLabel = ***REMOVED***kind: "switch"***REMOVED***;

pp$1.isLet = function(context) ***REMOVED***
  ...
  if (nextCh === 91) ***REMOVED*** return true ***REMOVED*** // '['
  if (context) ***REMOVED*** return false ***REMOVED***

  if (nextCh === 123) ***REMOVED*** return true ***REMOVED*** // '***REMOVED***'
...
pp$1.parseStatement = function(context, topLevel, exports) ***REMOVED***
  var starttype = this.type, node = this.startNode(), kind;

  if (this.isLet(context)) ***REMOVED***
...
***REMOVED***
  ...
  case types._function:
    ...
    if ((context && (this.strict || context !== "if" && context !== "label")) && this.options.ecmaVersion >= 6) ***REMOVED*** this.unexpected(); ***REMOVED***
    return this.parseFunctionStatement(node, false, !context)
  case types._class:
    if (context) ***REMOVED*** this.unexpected(); ***REMOVED***
  ...
  case types._const: case types._var:
    ...
    if (context && kind !== "var") ***REMOVED*** this.unexpected(); ***REMOVED***
  ...
  case types._export:
  case types._import:
    if (this.options.ecmaVersion > 10 && starttype === types._import) ***REMOVED***
      skipWhiteSpace.lastIndex = this.pos;
      var skip = skipWhiteSpace.exec(this.input);
      var next = this.pos + skip[0].length, nextCh = this.input.charCodeAt(next);
      if (nextCh === 40 || nextCh === 46) // '(' or '.'
        ***REMOVED*** return this.parseExpressionStatement(node, this.parseExpression()) ***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    if (starttype === types.name && expr.type === "Identifier" && this.eat(types.colon))
      ***REMOVED*** return this.parseLabeledStatement(node, maybeName, expr, context) ***REMOVED***
...
***REMOVED***
  ...
  if (this.type === types._var || this.type === types._const || isLet) ***REMOVED***
    ...
    if ((this.type === types._in || (this.options.ecmaVersion >= 6 && this.isContextual("of"))) && init$1.declarations.length === 1) ***REMOVED***
...
pp$1.parseFunctionStatement = function(node, isAsync, declarationPosition) ***REMOVED***
  this.next();
...
pp$1.parseSwitchStatement = function(node) ***REMOVED***
  ...
  for (var sawDefault = false; this.type !== types.braceR;) ***REMOVED***
    if (this.type === types._case || this.type === types._default) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
        if (sawDefault) ***REMOVED*** this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"); ***REMOVED***
        sawDefault = true;
        cur.test = null;
  ***REMOVED***
      this.expect(types.colon);
***REMOVED*** else ***REMOVED***
      if (!cur) ***REMOVED*** this.unexpected(); ***REMOVED***
...
pp$1.parseTryStatement = function(node) ***REMOVED***
  ...
  if (this.type === types._catch) ***REMOVED***
    ...
    this.next();
    if (this.eat(types.parenL)) ***REMOVED***
...
***REMOVED*** else ***REMOVED***
      if (this.options.ecmaVersion < 10) ***REMOVED*** this.unexpected(); ***REMOVED***
      clause.param = null;
      this.enterScope(0);
***REMOVED***
...
pp$1.parseLabeledStatement = function(node, maybeName, expr, context) ***REMOVED***
  for (var i$1 = 0, list = this.labels; i$1 < list.length; i$1 += 1)
    ***REMOVED***
    var label = list[i$1];

    if (label.name === maybeName)
      ***REMOVED*** this.raise(expr.start, "Label '" + maybeName + "' is already declared");
***REMOVED*** ***REMOVED***
...
pp$1.parseBlock = function(createNewLexicalScope, node, exitStrict) ***REMOVED***
  if ( createNewLexicalScope === void 0 ) createNewLexicalScope = true;
  if ( node === void 0 ) node = this.startNode();

  node.body = [];
  this.expect(types.braceL);
  if (createNewLexicalScope) ***REMOVED*** this.enterScope(0); ***REMOVED***
  while (this.type !== types.braceR) ***REMOVED***
    var stmt = this.parseStatement(null);
    node.body.push(stmt);
***REMOVED***
  if (exitStrict) ***REMOVED*** this.strict = false; ***REMOVED***
  this.next();
  if (createNewLexicalScope) ***REMOVED*** this.exitScope(); ***REMOVED***
...
***REMOVED*** else if (init.type === "AssignmentPattern") ***REMOVED***
...
pp$1.parseVar = function(node, isFor, kind) ***REMOVED***
  ...
  for (;;) ***REMOVED***
    ...
    if (this.eat(types.eq)) ***REMOVED***
      decl.init = this.parseMaybeAssign(isFor);
***REMOVED*** else if (kind === "const" && !(this.type === types._in || (this.options.ecmaVersion >= 6 && this.isContextual("of")))) ***REMOVED***
      this.unexpected();
***REMOVED*** else if (decl.id.type !== "Identifier" && !(isFor && (this.type === types._in || this.isContextual("of")))) ***REMOVED***
      this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value");
***REMOVED*** else ***REMOVED***
      decl.init = null;
***REMOVED***
    node.declarations.push(this.finishNode(decl, "VariableDeclarator"));
    if (!this.eat(types.comma)) ***REMOVED*** break ***REMOVED***
***REMOVED***
  return node
***REMOVED***;
...
pp$1.parseFunction = function(node, statement, allowExpressionBody, isAsync) ***REMOVED***
  this.initFunction(node);
  if (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !isAsync) ***REMOVED***
...
***REMOVED***
  ...
  if (statement & FUNC_STATEMENT) ***REMOVED***
    ...
    if (node.id && !(statement & FUNC_HANGING_STATEMENT))
      ...
      // treatFunctionsAsVar).
      ***REMOVED*** this.checkLVal(node.id, (this.strict || node.generator || node.async) ? this.treatFunctionsAsVar ? BIND_VAR : BIND_LEXICAL : BIND_FUNCTION); ***REMOVED***
***REMOVED***
...
pp$1.parseClass = function(node, isStatement) ***REMOVED***
  ...
  while (this.type !== types.braceR) ***REMOVED***
    ...
    if (element) ***REMOVED***
      ...
      if (element.type === "MethodDefinition" && element.kind === "constructor") ***REMOVED***
        if (hadConstructor) ***REMOVED*** this.raise(element.start, "Duplicate constructor in the same class"); ***REMOVED***
        hadConstructor = true;
  ***REMOVED***
***REMOVED***
***REMOVED***
...
pp$1.parseClassElement = function(constructorAllowsSuper) ***REMOVED***
  var this$1 = this;
...
pp$1.parseClassMethod = function(method, isGenerator, isAsync, allowsDirectSuper) ***REMOVED***
...
pp$1.parseClassId = function(node, isStatement) ***REMOVED***
  if (this.type === types.name) ***REMOVED***
    ...
    if (isStatement)
      ***REMOVED*** this.checkLVal(node.id, BIND_LEXICAL, false); ***REMOVED***
***REMOVED*** else ***REMOVED***
    if (isStatement === true)
      ***REMOVED*** this.unexpected(); ***REMOVED***
    node.id = null;
...
pp$1.parseExport = function(node, exports) ***REMOVED***
  ...
  if (this.eat(types.star)) ***REMOVED***
    if (this.options.ecmaVersion >= 11) ***REMOVED***
  ...
  ***REMOVED*** ***REMOVED***
    ...
    ***REMOVED*** for (var i$1 = 0, list$1 = pat.elements; i$1 < list$1.length; i$1 += 1) ***REMOVED***
      var elt = list$1[i$1];
        ...
        if (elt) ***REMOVED*** this.checkPatternExport(exports, elt); ***REMOVED***
***REMOVED*** ***REMOVED***
...
pp$1.parseExportSpecifiers = function(exports) ***REMOVED***
  ...
  while (!this.eat(types.braceR)) ***REMOVED***
    if (!first) ***REMOVED***
      ...
      if (this.afterTrailingComma(types.braceR)) ***REMOVED*** break ***REMOVED***
  ...
  if (this.options.ecmaVersion >= 6 && node) ***REMOVED***
    ...
    case "Identifier":
      if (this.inAsync && node.name === "await")
        ***REMOVED*** this.raise(node.start, "Cannot use 'await' as identifier inside an async function"); ***REMOVED***
      break
...
pp$2.toAssignableList = function(exprList, isBinding) ***REMOVED***
  ...
  for (var i = 0; i < end; i++) ***REMOVED***
    var elt = exprList[i];
    if (elt) ***REMOVED*** this.toAssignable(elt, isBinding); ***REMOVED***
***REMOVED***
  if (end) ***REMOVED***
...
pp$2.parseBindingList = function(close, allowEmpty, allowTrailingComma) ***REMOVED***
  ...
  while (!this.eat(close)) ***REMOVED***
    ...
    else ***REMOVED*** this.expect(types.comma); ***REMOVED***
    if (allowEmpty && this.type === types.comma) ***REMOVED***
      elts.push(null);
***REMOVED*** else if (allowTrailingComma && this.afterTrailingComma(close)) ***REMOVED***
      break
***REMOVED*** else if (this.type === types.ellipsis) ***REMOVED***
      var rest = this.parseRestBinding();
      this.parseBindingListItem(rest);
      elts.push(rest);
      if (this.type === types.comma) ***REMOVED*** this.raise(this.start, "Comma is not permitted after the rest element"); ***REMOVED***
      this.expect(close);
      break
***REMOVED*** else ***REMOVED***
...
pp$2.checkLVal = function(expr, bindingType, checkClashes) ***REMOVED***
  ...
  case "Identifier":
    if (bindingType === BIND_LEXICAL && expr.name === "let")
      ***REMOVED*** this.raiseRecoverable(expr.start, "let is disallowed as a lexically bound name"); ***REMOVED***
...
***REMOVED***
    if (bindingType !== BIND_NONE && bindingType !== BIND_OUTSIDE) ***REMOVED*** this.declareName(expr.name, bindingType, expr.start); ***REMOVED***
    break
...
***REMOVED***
  ...
  case "ArrayPattern":
    ...
    if (elem) ***REMOVED*** this.checkLVal(elem, bindingType, checkClashes); ***REMOVED***
***REMOVED***
    break
      ...
      if (propHash.proto) ***REMOVED***
        if (refDestructuringErrors) ***REMOVED***
          if (refDestructuringErrors.doubleProto < 0)
            ***REMOVED*** refDestructuringErrors.doubleProto = key.start; ***REMOVED***
          // Backwards-compat kludge. Can be removed in version 6.0
    ***REMOVED*** else ***REMOVED*** this.raiseRecoverable(key.start, "Redefinition of __proto__ property"); ***REMOVED***
  ***REMOVED***
      propHash.proto = true;
***REMOVED***
    return
...
pp$3.parseExpression = function(noIn, refDestructuringErrors) ***REMOVED***
  ...
  if (this.type === types.comma) ***REMOVED***
    ...
    while (this.eat(types.comma)) ***REMOVED*** node.expressions.push(this.parseMaybeAssign(noIn, refDestructuringErrors)); ***REMOVED***
...
pp$3.parseMaybeAssign = function(noIn, refDestructuringErrors, afterLeftParse) ***REMOVED***
  if (this.isContextual("yield")) ***REMOVED***
    if (this.inGenerator) ***REMOVED*** return this.parseYield(noIn) ***REMOVED***
    // The tokenizer will assume an expression is allowed after
    // `yield`, but this isn't that kind of yield
    else ***REMOVED*** this.exprAllowed = false; ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  if (this.type.isAssign) ***REMOVED***
    ...
    if (!ownDestructuringErrors) ***REMOVED***
      refDestructuringErrors.parenthesizedAssign = refDestructuringErrors.trailingComma = refDestructuringErrors.doubleProto = -1;
***REMOVED***
    if (refDestructuringErrors.shorthandAssign >= node.left.start)
      ***REMOVED*** refDestructuringErrors.shorthandAssign = -1; ***REMOVED*** // reset because shorthand default was used correctly
    this.checkLVal(left);
    this.next();
...
pp$3.parseExprOp = function(left, leftStartPos, leftStartLoc, minPrec, noIn) ***REMOVED***
  ...
  ***REMOVED***
      ...
      if ((logical && this.type === types.coalesce) || (coalesce && (this.type === types.logicalOR || this.type === types.logicalAND))) ***REMOVED***
...
pp$3.parseMaybeUnary = function(refDestructuringErrors, sawUnary) ***REMOVED***
  ...
  if (this.isContextual("await") && (this.inAsync || (!this.inFunction && this.options.allowAwaitOutsideFunction))) ***REMOVED***
...
pp$3.parseSubscripts = function(base, startPos, startLoc, noCalls) ***REMOVED***
  ...
  while (true) ***REMOVED***
    ...
    if (element.optional) ***REMOVED*** optionalChained = true; ***REMOVED***
    if (element === base || element.type === "ArrowFunctionExpression") ***REMOVED***
      if (optionalChained) ***REMOVED***
...
pp$3.parseSubscript = function(base, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained) ***REMOVED***
  var optionalSupported = this.options.ecmaVersion >= 11;
  var optional = optionalSupported && this.eat(types.questionDot);
  if (noCalls && optional) ***REMOVED*** this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions"); ***REMOVED***

  var computed = this.eat(types.bracketL);
  if (computed || (optional && this.type !== types.parenL && this.type !== types.backQuote) || this.eat(types.dot)) ***REMOVED***
    var node = this.startNodeAt(startPos, startLoc);
    node.object = base;
    node.property = computed ? this.parseExpression() : this.parseIdent(this.options.allowReserved !== "never");
    node.computed = !!computed;
    if (computed) ***REMOVED*** this.expect(types.bracketR); ***REMOVED***
    if (optionalSupported) ***REMOVED***
      node.optional = optional;
***REMOVED***
    base = this.finishNode(node, "MemberExpression");
***REMOVED*** else if (!noCalls && this.eat(types.parenL)) ***REMOVED***
    var refDestructuringErrors = new DestructuringErrors, oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
    this.yieldPos = 0;
    this.awaitPos = 0;
    this.awaitIdentPos = 0;
    var exprList = this.parseExprList(types.parenR, this.options.ecmaVersion >= 8, false, refDestructuringErrors);
    if (maybeAsyncArrow && !optional && !this.canInsertSemicolon() && this.eat(types.arrow)) ***REMOVED***
      this.checkPatternErrors(refDestructuringErrors, false);
      this.checkYieldAwaitInDefaultParams();
      if (this.awaitIdentPos > 0)
        ***REMOVED*** this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"); ***REMOVED***
      this.yieldPos = oldYieldPos;
      this.awaitPos = oldAwaitPos;
      this.awaitIdentPos = oldAwaitIdentPos;
...
***REMOVED*** else if (this.type === types.backQuote) ***REMOVED***
    if (optional || optionalChained) ***REMOVED***
      this.raise(this.start, "Optional chaining cannot appear in the tag of tagged template expressions");
***REMOVED***
    var node$2 = this.startNodeAt(startPos, startLoc);
    node$2.tag = base;
    node$2.quasi = this.parseTemplate(***REMOVED***isTagged: true***REMOVED***);
...
pp$3.parseExprAtom = function(refDestructuringErrors) ***REMOVED***
  ...
  if (this.type === types.slash) ***REMOVED*** this.readRegexp(); ***REMOVED***

  var node, canBeArrow = this.potentialArrowAt === this.start;
  switch (this.type) ***REMOVED***
  case types._super:
    if (!this.allowSuper)
      ***REMOVED*** this.raise(this.start, "'super' keyword outside a method"); ***REMOVED***
    node = this.startNode();
    this.next();
    if (this.type === types.parenL && !this.allowDirectSuper)
      ***REMOVED*** this.raise(node.start, "super() call outside constructor of a subclass"); ***REMOVED***
  ...
  case types.name:
    ...
    if (this.options.ecmaVersion >= 8 && !containsEsc && id.name === "async" && !this.canInsertSemicolon() && this.eat(types._function))
      ***REMOVED*** return this.parseFunction(this.startNodeAt(startPos, startLoc), 0, false, true) ***REMOVED***
...
pp$3.parseExprImport = function() ***REMOVED***
  var node = this.startNode();

  // Consume `import` as an identifier for `import.meta`.
  // Because `this.parseIdent(true)` doesn't check escape sequences, it needs the check of `this.containsEsc`.
  if (this.containsEsc) ***REMOVED*** this.raiseRecoverable(this.start, "Escape sequence in keyword import"); ***REMOVED***
...
pp$3.parseDynamicImport = function(node) ***REMOVED***
  this.next(); // skip `(`
  ...
  // Verify ending.
  if (!this.eat(types.parenR)) ***REMOVED***
    var errorPos = this.start;
    if (this.eat(types.comma) && this.eat(types.parenR)) ***REMOVED***
...
pp$3.parseImportMeta = function(node) ***REMOVED***
  this.next(); // skip `.`
  ...
  if (node.property.name !== "meta")
    ***REMOVED*** this.raiseRecoverable(node.property.start, "The only valid meta property for import is 'import.meta'"); ***REMOVED***
  if (containsEsc)
    ***REMOVED*** this.raiseRecoverable(node.start, "'import.meta' must not contain escaped characters"); ***REMOVED***
  if (this.options.sourceType !== "module")
    ***REMOVED*** this.raiseRecoverable(node.start, "Cannot use 'import.meta' outside a module"); ***REMOVED***
...
pp$3.parseLiteral = function(value) ***REMOVED***
  ...
  if (node.raw.charCodeAt(node.raw.length - 1) === 110) ***REMOVED*** node.bigint = node.raw.slice(0, -1).replace(/_/g, ""); ***REMOVED***
  this.next();
  return this.finishNode(node, "Literal")
***REMOVED***;
...
pp$3.parseParenAndDistinguishExpression = function(canBeArrow) ***REMOVED***
  ...
  if (this.options.ecmaVersion >= 6) ***REMOVED***
    ...
    while (this.type !== types.parenR) ***REMOVED***
      ...
      if (allowTrailingComma && this.afterTrailingComma(types.parenR, true)) ***REMOVED***
        lastIsComma = true;
        break
  ***REMOVED*** else if (this.type === types.ellipsis) ***REMOVED***
...
pp$3.parseNew = function() ***REMOVED***
  if (this.containsEsc) ***REMOVED*** this.raiseRecoverable(this.start, "Escape sequence in keyword new"); ***REMOVED***
  var node = this.startNode();
  var meta = this.parseIdent(true);
  if (this.options.ecmaVersion >= 6 && this.eat(types.dot)) ***REMOVED***
    ...
    if (containsEsc)
      ***REMOVED*** this.raiseRecoverable(node.start, "'new.target' must not contain escaped characters"); ***REMOVED***
...
***REMOVED***
  ...
  if (isImport && node.callee.type === "ImportExpression") ***REMOVED***
...
pp$3.parseTemplate = function(ref) ***REMOVED***
  ...
  while (!curElt.tail) ***REMOVED***
    if (this.type === types.eof) ***REMOVED*** this.raise(this.pos, "Unterminated template literal"); ***REMOVED***
    this.expect(types.dollarBraceL);
    node.expressions.push(this.parseExpression());
    this.expect(types.braceR);
    node.quasis.push(curElt = this.parseTemplateElement(***REMOVED***isTagged: isTagged***REMOVED***));
***REMOVED***
  this.next();
...
pp$3.parseObj = function(isPattern, refDestructuringErrors) ***REMOVED***
  ...
  while (!this.eat(types.braceR)) ***REMOVED***
    if (!first) ***REMOVED***
      this.expect(types.comma);
      if (this.options.ecmaVersion >= 5 && this.afterTrailingComma(types.braceR)) ***REMOVED*** break ***REMOVED***
***REMOVED*** else ***REMOVED*** first = false; ***REMOVED***

    var prop = this.parseProperty(isPattern, refDestructuringErrors);
    if (!isPattern) ***REMOVED*** this.checkPropClash(prop, propHash, refDestructuringErrors); ***REMOVED***
...
***REMOVED*** else if (!isPattern && !containsEsc &&
             ...
             (this.type !== types.comma && this.type !== types.braceR && this.type !== types.eq)) ***REMOVED***
...
***REMOVED*** else if (this.options.ecmaVersion >= 6 && !prop.computed && prop.key.type === "Identifier") ***REMOVED***
    ...
    if (prop.key.name === "await" && !this.awaitIdentPos)
      ***REMOVED*** this.awaitIdentPos = startPos; ***REMOVED***
    prop.kind = "init";
    if (isPattern) ***REMOVED***
...
pp$3.initFunction = function(node) ***REMOVED***
  node.id = null;
  if (this.options.ecmaVersion >= 6) ***REMOVED*** node.generator = node.expression = false; ***REMOVED***
  if (this.options.ecmaVersion >= 8) ***REMOVED*** node.async = false; ***REMOVED***
***REMOVED***;

// Parse object or class method.

pp$3.parseMethod = function(isGenerator, isAsync, allowDirectSuper) ***REMOVED***
...
pp$3.parseArrowExpression = function(node, params, isAsync) ***REMOVED***
  ...
  this.initFunction(node);
  if (this.options.ecmaVersion >= 8) ***REMOVED*** node.async = !!isAsync; ***REMOVED***
...
pp$3.parseFunctionBody = function(node, isArrowFunction, isMethod) ***REMOVED***
...
***REMOVED***
    ...
    if (this.strict && node.id) ***REMOVED*** this.checkLVal(node.id, BIND_OUTSIDE); ***REMOVED***
...
pp$3.parseExprList = function(close, allowTrailingComma, allowEmpty, refDestructuringErrors) ***REMOVED***
  ...
  while (!this.eat(close)) ***REMOVED***
    if (!first) ***REMOVED***
      this.expect(types.comma);
      if (allowTrailingComma && this.afterTrailingComma(close)) ***REMOVED*** break ***REMOVED***
***REMOVED*** else ***REMOVED*** first = false; ***REMOVED***

    var elt = (void 0);
    if (allowEmpty && this.type === types.comma)
      ***REMOVED*** elt = null; ***REMOVED***
    else if (this.type === types.ellipsis) ***REMOVED***
      elt = this.parseSpread(refDestructuringErrors);
      if (refDestructuringErrors && this.type === types.comma && refDestructuringErrors.trailingComma < 0)
        ***REMOVED*** refDestructuringErrors.trailingComma = this.start; ***REMOVED***
***REMOVED*** else ***REMOVED***
...
pp$3.checkUnreserved = function(ref) ***REMOVED***
  ...
  if (this.inGenerator && name === "yield")
    ***REMOVED*** this.raiseRecoverable(start, "Cannot use 'yield' as identifier inside a generator"); ***REMOVED***
  if (this.inAsync && name === "await")
    ***REMOVED*** this.raiseRecoverable(start, "Cannot use 'await' as identifier inside an async function"); ***REMOVED***
  ...
  if (re.test(name)) ***REMOVED***
    if (!this.inAsync && name === "await")
      ***REMOVED*** this.raiseRecoverable(start, "Cannot use keyword 'await' outside an async function"); ***REMOVED***
...
***REMOVED***
  ...
  if (!liberal) ***REMOVED***
    ...
    if (node.name === "await" && !this.awaitIdentPos)
      ***REMOVED*** this.awaitIdentPos = node.start; ***REMOVED***
***REMOVED***
  return node
***REMOVED***;
...
pp$3.parseYield = function(noIn) ***REMOVED***
...
var Scope = function Scope(flags) ***REMOVED***
  this.flags = flags;
...
pp$5.enterScope = function(flags) ***REMOVED***
  this.scopeStack.push(new Scope(flags));
***REMOVED***;

pp$5.exitScope = function() ***REMOVED***
  this.scopeStack.pop();
***REMOVED***;
...
pp$5.treatFunctionsAsVarInScope = function(scope) ***REMOVED***
  return (scope.flags & SCOPE_FUNCTION) || !this.inModule && (scope.flags & SCOPE_TOP)
***REMOVED***;

pp$5.declareName = function(name, bindingType, pos) ***REMOVED***
  var redeclared = false;
  if (bindingType === BIND_LEXICAL) ***REMOVED***
    var scope = this.currentScope();
    redeclared = scope.lexical.indexOf(name) > -1 || scope.functions.indexOf(name) > -1 || scope.var.indexOf(name) > -1;
    scope.lexical.push(name);
    if (this.inModule && (scope.flags & SCOPE_TOP))
      ***REMOVED*** delete this.undefinedExports[name]; ***REMOVED***
***REMOVED*** else if (bindingType === BIND_SIMPLE_CATCH) ***REMOVED***
    var scope$1 = this.currentScope();
    scope$1.lexical.push(name);
***REMOVED*** else if (bindingType === BIND_FUNCTION) ***REMOVED***
    var scope$2 = this.currentScope();
    if (this.treatFunctionsAsVar)
      ***REMOVED*** redeclared = scope$2.lexical.indexOf(name) > -1; ***REMOVED***
    else
      ***REMOVED*** redeclared = scope$2.lexical.indexOf(name) > -1 || scope$2.var.indexOf(name) > -1; ***REMOVED***
    scope$2.functions.push(name);
***REMOVED*** else ***REMOVED***
    for (var i = this.scopeStack.length - 1; i >= 0; --i) ***REMOVED***
      var scope$3 = this.scopeStack[i];
      if (scope$3.lexical.indexOf(name) > -1 && !((scope$3.flags & SCOPE_SIMPLE_CATCH) && scope$3.lexical[0] === name) ||
          !this.treatFunctionsAsVarInScope(scope$3) && scope$3.functions.indexOf(name) > -1) ***REMOVED***
        redeclared = true;
        break
  ***REMOVED***
      ...
      if (this.inModule && (scope$3.flags & SCOPE_TOP))
        ***REMOVED*** delete this.undefinedExports[name]; ***REMOVED***
      if (scope$3.flags & SCOPE_VAR) ***REMOVED*** break ***REMOVED***
***REMOVED***
***REMOVED***
  if (redeclared) ***REMOVED*** this.raiseRecoverable(pos, ("Identifier '" + name + "' has already been declared")); ***REMOVED***
***REMOVED***;

pp$5.checkLocalExport = function(id) ***REMOVED***
  // scope.functions must be empty as Module code is always strict.
  if (this.scopeStack[0].lexical.indexOf(id.name) === -1 &&
      this.scopeStack[0].var.indexOf(id.name) === -1) ***REMOVED***
    this.undefinedExports[id.name] = id;
***REMOVED***
***REMOVED***;

pp$5.currentScope = function() ***REMOVED***
  return this.scopeStack[this.scopeStack.length - 1]
***REMOVED***;

pp$5.currentVarScope = function() ***REMOVED***
  for (var i = this.scopeStack.length - 1;; i--) ***REMOVED***
    var scope = this.scopeStack[i];
    if (scope.flags & SCOPE_VAR) ***REMOVED*** return scope ***REMOVED***
***REMOVED***
***REMOVED***;

// Could be useful for `this`, `new.target`, `super()`, `super.property`, and `super[property]`.
pp$5.currentThisScope = function() ***REMOVED***
  for (var i = this.scopeStack.length - 1;; i--) ***REMOVED***
    var scope = this.scopeStack[i];
    if (scope.flags & SCOPE_VAR && !(scope.flags & SCOPE_ARROW)) ***REMOVED*** return scope ***REMOVED***
***REMOVED***
***REMOVED***;
...
types.name.updateContext = function(prevType) ***REMOVED***
  var allowed = false;
  if (this.options.ecmaVersion >= 6 && prevType !== types.dot) ***REMOVED***
...
var unicodeBinaryProperties = ***REMOVED***
...
var unicodeScriptValues = ***REMOVED***
  9: ecma9ScriptValues,
...
function buildUnicodeData(ecmaVersion) ***REMOVED***
  var d = data[ecmaVersion] = ***REMOVED***
...
var RegExpValidationState = function RegExpValidationState(parser) ***REMOVED***
  this.parser = parser;
...
RegExpValidationState.prototype.reset = function reset (start, pattern, flags) ***REMOVED***
...
RegExpValidationState.prototype.raise = function raise (message) ***REMOVED***
  this.parser.raiseRecoverable(this.start, ("Invalid regular expression: /" + (this.source) + "/: " + message));
***REMOVED***;

// If u flag is given, this returns the code point at the index (it combines a surrogate pair).
// Otherwise, this returns the code unit of the index (can be a part of a surrogate pair).
RegExpValidationState.prototype.at = function at (i, forceU) ***REMOVED***
...
***REMOVED***
  ...
  if (!(forceU || this.switchU) || c <= 0xD7FF || c >= 0xE000 || i + 1 >= l) ***REMOVED***
    return c
***REMOVED***
...
RegExpValidationState.prototype.nextIndex = function nextIndex (i, forceU) ***REMOVED***
    if ( forceU === void 0 ) forceU = false;
...
***REMOVED***
  ...
  if (!(forceU || this.switchU) || c <= 0xD7FF || c >= 0xE000 || i + 1 >= l ||
      (next = s.charCodeAt(i + 1)) < 0xDC00 || next > 0xDFFF) ***REMOVED***
    return i + 1
***REMOVED***
  return i + 2
***REMOVED***;

RegExpValidationState.prototype.current = function current (forceU) ***REMOVED***
    if ( forceU === void 0 ) forceU = false;

  return this.at(this.pos, forceU)
***REMOVED***;

RegExpValidationState.prototype.lookahead = function lookahead (forceU) ***REMOVED***
    if ( forceU === void 0 ) forceU = false;

  return this.at(this.nextIndex(this.pos, forceU), forceU)
***REMOVED***;

RegExpValidationState.prototype.advance = function advance (forceU) ***REMOVED***
    if ( forceU === void 0 ) forceU = false;

  this.pos = this.nextIndex(this.pos, forceU);
***REMOVED***;

RegExpValidationState.prototype.eat = function eat (ch, forceU) ***REMOVED***
    if ( forceU === void 0 ) forceU = false;

  if (this.current(forceU) === ch) ***REMOVED***
    this.advance(forceU);
    return true
***REMOVED***
  return false
...
function codePointToString(ch) ***REMOVED***
  if (ch <= 0xFFFF) ***REMOVED*** return String.fromCharCode(ch) ***REMOVED***
  ch -= 0x10000;
 ...
 *
 * @param ***REMOVED***RegExpValidationState***REMOVED*** state The state to validate RegExp.
 * @returns ***REMOVED***void***REMOVED***
 */
pp$8.validateRegExpFlags = function(state) ***REMOVED***
  var validFlags = state.validFlags;
  var flags = state.flags;

  for (var i = 0; i < flags.length; i++) ***REMOVED***
    var flag = flags.charAt(i);
    if (validFlags.indexOf(flag) === -1) ***REMOVED***
      this.raise(state.start, "Invalid regular expression flag");
***REMOVED***
    if (flags.indexOf(flag, i + 1) > -1) ***REMOVED***
 ...
 * @returns ***REMOVED***void***REMOVED***
 */
pp$8.validateRegExpPattern = function(state) ***REMOVED***
  ...
  if (!state.switchN && this.options.ecmaVersion >= 9 && state.groupNames.length > 0) ***REMOVED***
    state.switchN = true;
    this.regexp_pattern(state);
***REMOVED***
***REMOVED***;
...
pp$8.regexp_pattern = function(state) ***REMOVED***
  state.pos = 0;
  ...
  if (state.pos !== state.source.length) ***REMOVED***
    // Make the same messages as V8.
    if (state.eat(0x29 /* ) */)) ***REMOVED***
      state.raise("Unmatched ')'");
***REMOVED***
    if (state.eat(0x5D /* ] */) || state.eat(0x7D /* ***REMOVED*** */)) ***REMOVED***
      state.raise("Lone quantifier brackets");
***REMOVED***
***REMOVED***
  if (state.maxBackReference > state.numCapturingParens) ***REMOVED***
    state.raise("Invalid escape");
***REMOVED***
  for (var i = 0, list = state.backReferenceNames; i < list.length; i += 1) ***REMOVED***
    var name = list[i];

    if (state.groupNames.indexOf(name) === -1) ***REMOVED***
...
pp$8.regexp_disjunction = function(state) ***REMOVED***
  this.regexp_alternative(state);
  while (state.eat(0x7C /* | */)) ***REMOVED***
    this.regexp_alternative(state);
***REMOVED***

  // Make the same message as V8.
  if (this.regexp_eatQuantifier(state, true)) ***REMOVED***
    state.raise("Nothing to repeat");
***REMOVED***
  if (state.eat(0x7B /* ***REMOVED*** */)) ***REMOVED***
    state.raise("Lone quantifier brackets");
***REMOVED***
***REMOVED***;

// https://www.ecma-international.org/ecma-262/8.0/#prod-Alternative
pp$8.regexp_alternative = function(state) ***REMOVED***
  while (state.pos < state.source.length && this.regexp_eatTerm(state))
    ***REMOVED*** ***REMOVED***
***REMOVED***;

// https://www.ecma-international.org/ecma-262/8.0/#prod-annexB-Term
pp$8.regexp_eatTerm = function(state) ***REMOVED***
  if (this.regexp_eatAssertion(state)) ***REMOVED***
    // Handle `QuantifiableAssertion Quantifier` alternative.
    // `state.lastAssertionIsQuantifiable` is true if the last eaten Assertion
    // is a QuantifiableAssertion.
    if (state.lastAssertionIsQuantifiable && this.regexp_eatQuantifier(state)) ***REMOVED***
      // Make the same message as V8.
      if (state.switchU) ***REMOVED***
...
***REMOVED***
  ...
  if (state.switchU ? this.regexp_eatAtom(state) : this.regexp_eatExtendedAtom(state)) ***REMOVED***
...
pp$8.regexp_eatAssertion = function(state) ***REMOVED***
  var start = state.pos;
  state.lastAssertionIsQuantifiable = false;

  // ^, $
  if (state.eat(0x5E /* ^ */) || state.eat(0x24 /* $ */)) ***REMOVED***
    return true
***REMOVED***

  // \b \B
  if (state.eat(0x5C /* \ */)) ***REMOVED***
    if (state.eat(0x42 /* B */) || state.eat(0x62 /* b */)) ***REMOVED***
      return true
***REMOVED***
    state.pos = start;
***REMOVED***
  ...
  if (state.eat(0x28 /* ( */) && state.eat(0x3F /* ? */)) ***REMOVED***
    var lookbehind = false;
    if (this.options.ecmaVersion >= 9) ***REMOVED***
      lookbehind = state.eat(0x3C /* < */);
***REMOVED***
    if (state.eat(0x3D /* = */) || state.eat(0x21 /* ! */)) ***REMOVED***
      this.regexp_disjunction(state);
      if (!state.eat(0x29 /* ) */)) ***REMOVED***
...
pp$8.regexp_eatQuantifier = function(state, noError) ***REMOVED***
  if ( noError === void 0 ) noError = false;

  if (this.regexp_eatQuantifierPrefix(state, noError)) ***REMOVED***
    state.eat(0x3F /* ? */);
    return true
***REMOVED***
  return false
...
pp$8.regexp_eatQuantifierPrefix = function(state, noError) ***REMOVED***
  return (
    state.eat(0x2A /* * */) ||
    state.eat(0x2B /* + */) ||
    state.eat(0x3F /* ? */) ||
...
***REMOVED***;
pp$8.regexp_eatBracedQuantifier = function(state, noError) ***REMOVED***
  var start = state.pos;
  if (state.eat(0x7B /* ***REMOVED*** */)) ***REMOVED***
    var min = 0, max = -1;
    if (this.regexp_eatDecimalDigits(state)) ***REMOVED***
      min = state.lastIntValue;
      if (state.eat(0x2C /* , */) && this.regexp_eatDecimalDigits(state)) ***REMOVED***
        max = state.lastIntValue;
  ***REMOVED***
      if (state.eat(0x7D /* ***REMOVED*** */)) ***REMOVED***
        // SyntaxError in https://www.ecma-international.org/ecma-262/8.0/#sec-term
        if (max !== -1 && max < min && !noError) ***REMOVED***
          state.raise("numbers out of order in ***REMOVED******REMOVED*** quantifier");
    ***REMOVED***
        return true
  ***REMOVED***
***REMOVED***
    if (state.switchU && !noError) ***REMOVED***
...
pp$8.regexp_eatAtom = function(state) ***REMOVED***
  return (
...
***REMOVED***;
pp$8.regexp_eatReverseSolidusAtomEscape = function(state) ***REMOVED***
  var start = state.pos;
  if (state.eat(0x5C /* \ */)) ***REMOVED***
    if (this.regexp_eatAtomEscape(state)) ***REMOVED***
      return true
***REMOVED***
    state.pos = start;
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_eatUncapturingGroup = function(state) ***REMOVED***
  var start = state.pos;
  if (state.eat(0x28 /* ( */)) ***REMOVED***
    if (state.eat(0x3F /* ? */) && state.eat(0x3A /* : */)) ***REMOVED***
      this.regexp_disjunction(state);
      if (state.eat(0x29 /* ) */)) ***REMOVED***
        return true
  ***REMOVED***
...
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_eatCapturingGroup = function(state) ***REMOVED***
  if (state.eat(0x28 /* ( */)) ***REMOVED***
    if (this.options.ecmaVersion >= 9) ***REMOVED***
      this.regexp_groupSpecifier(state);
***REMOVED*** else if (state.current() === 0x3F /* ? */) ***REMOVED***
...
pp$8.regexp_eatExtendedAtom = function(state) ***REMOVED***
  return (
    state.eat(0x2E /* . */) ||
    this.regexp_eatReverseSolidusAtomEscape(state) ||
    this.regexp_eatCharacterClass(state) ||
...
pp$8.regexp_eatInvalidBracedQuantifier = function(state) ***REMOVED***
  if (this.regexp_eatBracedQuantifier(state, true)) ***REMOVED***
    state.raise("Nothing to repeat");
***REMOVED***
  return false
***REMOVED***;
...
pp$8.regexp_eatSyntaxCharacter = function(state) ***REMOVED***
  var ch = state.current();
  if (isSyntaxCharacter(ch)) ***REMOVED***
...
***REMOVED***
  return false
***REMOVED***;
function isSyntaxCharacter(ch) ***REMOVED***
  return (
    ch === 0x24 /* $ */ ||
    ch >= 0x28 /* ( */ && ch <= 0x2B /* + */ ||
    ch === 0x2E /* . */ ||
    ch === 0x3F /* ? */ ||
    ch >= 0x5B /* [ */ && ch <= 0x5E /* ^ */ ||
    ch >= 0x7B /* ***REMOVED*** */ && ch <= 0x7D /* ***REMOVED*** */
  )
***REMOVED***

// https://www.ecma-international.org/ecma-262/8.0/#prod-PatternCharacter
// But eat eager.
pp$8.regexp_eatPatternCharacters = function(state) ***REMOVED***
  var start = state.pos;
  var ch = 0;
  while ((ch = state.current()) !== -1 && !isSyntaxCharacter(ch)) ***REMOVED***
    state.advance();
***REMOVED***
...
pp$8.regexp_eatExtendedPatternCharacter = function(state) ***REMOVED***
  var ch = state.current();
  if (
    ch !== -1 &&
    ch !== 0x24 /* $ */ &&
...
//   [empty]
//   `?` GroupName
pp$8.regexp_groupSpecifier = function(state) ***REMOVED***
  if (state.eat(0x3F /* ? */)) ***REMOVED***
    if (this.regexp_eatGroupName(state)) ***REMOVED***
      if (state.groupNames.indexOf(state.lastStringValue) !== -1) ***REMOVED***
...
pp$8.regexp_eatGroupName = function(state) ***REMOVED***
  state.lastStringValue = "";
  if (state.eat(0x3C /* < */)) ***REMOVED***
    if (this.regexp_eatRegExpIdentifierName(state) && state.eat(0x3E /* > */)) ***REMOVED***
      return true
***REMOVED***
...
// Note: this updates `state.lastStringValue` property with the eaten name.
pp$8.regexp_eatRegExpIdentifierName = function(state) ***REMOVED***
  state.lastStringValue = "";
  if (this.regexp_eatRegExpIdentifierStart(state)) ***REMOVED***
    state.lastStringValue += codePointToString(state.lastIntValue);
    while (this.regexp_eatRegExpIdentifierPart(state)) ***REMOVED***
      state.lastStringValue += codePointToString(state.lastIntValue);
***REMOVED***
    return true
***REMOVED***
...
pp$8.regexp_eatRegExpIdentifierStart = function(state) ***REMOVED***
  var start = state.pos;
  var forceU = this.options.ecmaVersion >= 11;
  var ch = state.current(forceU);
  state.advance(forceU);

  if (ch === 0x5C /* \ */ && this.regexp_eatRegExpUnicodeEscapeSequence(state, forceU)) ***REMOVED***
    ch = state.lastIntValue;
***REMOVED***
  if (isRegExpIdentifierStart(ch)) ***REMOVED***
    state.lastIntValue = ch;
    return true
***REMOVED***
  ...
  return false
***REMOVED***;
function isRegExpIdentifierStart(ch) ***REMOVED***
...
//   <ZWNJ>
//   <ZWJ>
pp$8.regexp_eatRegExpIdentifierPart = function(state) ***REMOVED***
  var start = state.pos;
  var forceU = this.options.ecmaVersion >= 11;
  var ch = state.current(forceU);
  state.advance(forceU);
  ...
  if (ch === 0x5C /* \ */ && this.regexp_eatRegExpUnicodeEscapeSequence(state, forceU)) ***REMOVED***
    ch = state.lastIntValue;
***REMOVED***
  if (isRegExpIdentifierPart(ch)) ***REMOVED***
    state.lastIntValue = ch;
    return true
***REMOVED***
  ...
  return false
***REMOVED***;
function isRegExpIdentifierPart(ch) ***REMOVED***
  return isIdentifierChar(ch, true) || ch === 0x24 /* $ */ || ch === 0x5F /* _ */ || ch === 0x200C /* <ZWNJ> */ || ch === 0x200D /* <ZWJ> */
***REMOVED***

// https://www.ecma-international.org/ecma-262/8.0/#prod-annexB-AtomEscape
pp$8.regexp_eatAtomEscape = function(state) ***REMOVED***
  if (
...
***REMOVED***
  if (state.switchU) ***REMOVED***
    // Make the same message as V8.
    if (state.current() === 0x63 /* c */) ***REMOVED***
...
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_eatBackReference = function(state) ***REMOVED***
  var start = state.pos;
  if (this.regexp_eatDecimalEscape(state)) ***REMOVED***
    var n = state.lastIntValue;
    if (state.switchU) ***REMOVED***
      // For SyntaxError in https://www.ecma-international.org/ecma-262/8.0/#sec-atomescape
      if (n > state.maxBackReference) ***REMOVED***
        state.maxBackReference = n;
  ***REMOVED***
      return true
***REMOVED***
    if (n <= state.numCapturingParens) ***REMOVED***
      return true
***REMOVED***
    state.pos = start;
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_eatKGroupName = function(state) ***REMOVED***
  if (state.eat(0x6B /* k */)) ***REMOVED***
    if (this.regexp_eatGroupName(state)) ***REMOVED***
...
pp$8.regexp_eatCharacterEscape = function(state) ***REMOVED***
  return (
...
***REMOVED***;
pp$8.regexp_eatCControlLetter = function(state) ***REMOVED***
  var start = state.pos;
  if (state.eat(0x63 /* c */)) ***REMOVED***
    if (this.regexp_eatControlLetter(state)) ***REMOVED***
      return true
***REMOVED***
    state.pos = start;
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_eatZero = function(state) ***REMOVED***
  if (state.current() === 0x30 /* 0 */ && !isDecimalDigit(state.lookahead())) ***REMOVED***
    state.lastIntValue = 0;
    state.advance();
    return true
***REMOVED***
...
pp$8.regexp_eatControlEscape = function(state) ***REMOVED***
  var ch = state.current();
  if (ch === 0x74 /* t */) ***REMOVED***
    state.lastIntValue = 0x09; /* \t */
    state.advance();
    return true
***REMOVED***
  if (ch === 0x6E /* n */) ***REMOVED***
    state.lastIntValue = 0x0A; /* \n */
    state.advance();
    return true
***REMOVED***
  if (ch === 0x76 /* v */) ***REMOVED***
    state.lastIntValue = 0x0B; /* \v */
    state.advance();
    return true
***REMOVED***
  if (ch === 0x66 /* f */) ***REMOVED***
    state.lastIntValue = 0x0C; /* \f */
    state.advance();
    return true
***REMOVED***
  if (ch === 0x72 /* r */) ***REMOVED***
...
pp$8.regexp_eatControlLetter = function(state) ***REMOVED***
  var ch = state.current();
  if (isControlLetter(ch)) ***REMOVED***
...
***REMOVED***
  return false
***REMOVED***;
function isControlLetter(ch) ***REMOVED***
  return (
    (ch >= 0x41 /* A */ && ch <= 0x5A /* Z */) ||
    (ch >= 0x61 /* a */ && ch <= 0x7A /* z */)
  )
...
pp$8.regexp_eatRegExpUnicodeEscapeSequence = function(state, forceU) ***REMOVED***
  if ( forceU === void 0 ) forceU = false;

  var start = state.pos;
  var switchU = forceU || state.switchU;

  if (state.eat(0x75 /* u */)) ***REMOVED***
    if (this.regexp_eatFixedHexDigits(state, 4)) ***REMOVED***
      var lead = state.lastIntValue;
      if (switchU && lead >= 0xD800 && lead <= 0xDBFF) ***REMOVED***
        var leadSurrogateEnd = state.pos;
        if (state.eat(0x5C /* \ */) && state.eat(0x75 /* u */) && this.regexp_eatFixedHexDigits(state, 4)) ***REMOVED***
          var trail = state.lastIntValue;
          if (trail >= 0xDC00 && trail <= 0xDFFF) ***REMOVED***
...
***REMOVED***
    if (
      switchU &&
      state.eat(0x7B /* ***REMOVED*** */) &&
      this.regexp_eatHexDigits(state) &&
      state.eat(0x7D /* ***REMOVED*** */) &&
...
***REMOVED***
  ...
  return false
***REMOVED***;
function isValidUnicode(ch) ***REMOVED***
  return ch >= 0 && ch <= 0x10FFFF
***REMOVED***

// https://www.ecma-international.org/ecma-262/8.0/#prod-annexB-IdentityEscape
pp$8.regexp_eatIdentityEscape = function(state) ***REMOVED***
  if (state.switchU) ***REMOVED***
    if (this.regexp_eatSyntaxCharacter(state)) ***REMOVED***
      return true
***REMOVED***
    if (state.eat(0x2F /* / */)) ***REMOVED***
...
***REMOVED***
  ...
  var ch = state.current();
  if (ch !== 0x63 /* c */ && (!state.switchN || ch !== 0x6B /* k */)) ***REMOVED***
    state.lastIntValue = ch;
    state.advance();
    return true
***REMOVED***
...
pp$8.regexp_eatDecimalEscape = function(state) ***REMOVED***
  state.lastIntValue = 0;
  var ch = state.current();
  if (ch >= 0x31 /* 1 */ && ch <= 0x39 /* 9 */) ***REMOVED***
    do ***REMOVED***
      state.lastIntValue = 10 * state.lastIntValue + (ch - 0x30 /* 0 */);
      state.advance();
***REMOVED*** while ((ch = state.current()) >= 0x30 /* 0 */ && ch <= 0x39 /* 9 */)
    return true
***REMOVED***
  return false
***REMOVED***;
...
pp$8.regexp_eatCharacterClassEscape = function(state) ***REMOVED***
  var ch = state.current();

  if (isCharacterClassEscape(ch)) ***REMOVED***
...
***REMOVED***
  ...
  return false
***REMOVED***;
function isCharacterClassEscape(ch) ***REMOVED***
  return (
    ch === 0x64 /* d */ ||
    ch === 0x44 /* D */ ||
    ch === 0x73 /* s */ ||
...
pp$8.regexp_eatUnicodePropertyValueExpression = function(state) ***REMOVED***
  var start = state.pos;

  // UnicodePropertyName `=` UnicodePropertyValue
  if (this.regexp_eatUnicodePropertyName(state) && state.eat(0x3D /* = */)) ***REMOVED***
    var name = state.lastStringValue;
    if (this.regexp_eatUnicodePropertyValue(state)) ***REMOVED***
...
***REMOVED***
  ...
  // LoneUnicodePropertyNameOrValue
  if (this.regexp_eatLoneUnicodePropertyNameOrValue(state)) ***REMOVED***
...
***REMOVED***
  return false
***REMOVED***;
pp$8.regexp_validateUnicodePropertyNameAndValue = function(state, name, value) ***REMOVED***
  if (!has(state.unicodeProperties.nonBinary, name))
    ***REMOVED*** state.raise("Invalid property name"); ***REMOVED***
  if (!state.unicodeProperties.nonBinary[name].test(value))
    ***REMOVED*** state.raise("Invalid property value"); ***REMOVED***
***REMOVED***;
pp$8.regexp_validateUnicodePropertyNameOrValue = function(state, nameOrValue) ***REMOVED***
...
pp$8.regexp_eatUnicodePropertyName = function(state) ***REMOVED***
  var ch = 0;
  state.lastStringValue = "";
  while (isUnicodePropertyNameCharacter(ch = state.current())) ***REMOVED***
    state.lastStringValue += codePointToString(ch);
    state.advance();
***REMOVED***
  return state.lastStringValue !== ""
***REMOVED***;
function isUnicodePropertyNameCharacter(ch) ***REMOVED***
  return isControlLetter(ch) || ch === 0x5F /* _ */
***REMOVED***

// UnicodePropertyValue ::
//   UnicodePropertyValueCharacters
pp$8.regexp_eatUnicodePropertyValue = function(state) ***REMOVED***
  var ch = 0;
  state.lastStringValue = "";
  while (isUnicodePropertyValueCharacter(ch = state.current())) ***REMOVED***
    state.lastStringValue += codePointToString(ch);
    state.advance();
***REMOVED***
  return state.lastStringValue !== ""
***REMOVED***;
function isUnicodePropertyValueCharacter(ch) ***REMOVED***
  return isUnicodePropertyNameCharacter(ch) || isDecimalDigit(ch)
***REMOVED***

// LoneUnicodePropertyNameOrValue ::
//   UnicodePropertyValueCharacters
pp$8.regexp_eatLoneUnicodePropertyNameOrValue = function(state) ***REMOVED***
  return this.regexp_eatUnicodePropertyValue(state)
***REMOVED***;

// https://www.ecma-international.org/ecma-262/8.0/#prod-CharacterClass
pp$8.regexp_eatCharacterClass = function(state) ***REMOVED***
  if (state.eat(0x5B /* [ */)) ***REMOVED***
    state.eat(0x5E /* ^ */);
    this.regexp_classRanges(state);
    if (state.eat(0x5D /* ] */)) ***REMOVED***
      return true
***REMOVED***
...
pp$8.regexp_classRanges = function(state) ***REMOVED***
  while (this.regexp_eatClassAtom(state)) ***REMOVED***
    var left = state.lastIntValue;
    if (state.eat(0x2D /* - */) && this.regexp_eatClassAtom(state)) ***REMOVED***
      var right = state.lastIntValue;
      if (state.switchU && (left === -1 || right === -1)) ***REMOVED***
        state.raise("Invalid character class");
  ***REMOVED***
      if (left !== -1 && right !== -1 && left > right) ***REMOVED***
...
pp$8.regexp_eatClassAtom = function(state) ***REMOVED***
  var start = state.pos;

  if (state.eat(0x5C /* \ */)) ***REMOVED***
    if (this.regexp_eatClassEscape(state)) ***REMOVED***
      return true
***REMOVED***
    if (state.switchU) ***REMOVED***
      // Make the same message as V8.
      var ch$1 = state.current();
      if (ch$1 === 0x63 /* c */ || isOctalDigit(ch$1)) ***REMOVED***
...
pp$8.regexp_eatClassEscape = function(state) ***REMOVED***
  var start = state.pos;

  if (state.eat(0x62 /* b */)) ***REMOVED***
    state.lastIntValue = 0x08; /* <BS> */
    return true
***REMOVED***

  if (state.switchU && state.eat(0x2D /* - */)) ***REMOVED***
    state.lastIntValue = 0x2D; /* - */
    return true
***REMOVED***

  if (!state.switchU && state.eat(0x63 /* c */)) ***REMOVED***
    if (this.regexp_eatClassControlLetter(state)) ***REMOVED***
      return true
***REMOVED***
    state.pos = start;
***REMOVED***
...
pp$8.regexp_eatClassControlLetter = function(state) ***REMOVED***
  var ch = state.current();
  if (isDecimalDigit(ch) || ch === 0x5F /* _ */) ***REMOVED***
    state.lastIntValue = ch % 0x20;
    state.advance();
    return true
***REMOVED***
...
pp$8.regexp_eatHexEscapeSequence = function(state) ***REMOVED***
  var start = state.pos;
  if (state.eat(0x78 /* x */)) ***REMOVED***
    if (this.regexp_eatFixedHexDigits(state, 2)) ***REMOVED***
      return true
***REMOVED***
    if (state.switchU) ***REMOVED***
      state.raise("Invalid escape");
...
pp$8.regexp_eatDecimalDigits = function(state) ***REMOVED***
  var start = state.pos;
  var ch = 0;
  state.lastIntValue = 0;
  while (isDecimalDigit(ch = state.current())) ***REMOVED***
    state.lastIntValue = 10 * state.lastIntValue + (ch - 0x30 /* 0 */);
    state.advance();
***REMOVED***
  return state.pos !== start
***REMOVED***;
function isDecimalDigit(ch) ***REMOVED***
  return ch >= 0x30 /* 0 */ && ch <= 0x39 /* 9 */
***REMOVED***

// https://www.ecma-international.org/ecma-262/8.0/#prod-HexDigits
pp$8.regexp_eatHexDigits = function(state) ***REMOVED***
  var start = state.pos;
  var ch = 0;
  state.lastIntValue = 0;
  while (isHexDigit(ch = state.current())) ***REMOVED***
    state.lastIntValue = 16 * state.lastIntValue + hexToInt(ch);
    state.advance();
***REMOVED***
  return state.pos !== start
***REMOVED***;
function isHexDigit(ch) ***REMOVED***
  return (
    (ch >= 0x30 /* 0 */ && ch <= 0x39 /* 9 */) ||
    (ch >= 0x41 /* A */ && ch <= 0x46 /* F */) ||
    (ch >= 0x61 /* a */ && ch <= 0x66 /* f */)
...
***REMOVED***
function hexToInt(ch) ***REMOVED***
  if (ch >= 0x41 /* A */ && ch <= 0x46 /* F */) ***REMOVED***
    return 10 + (ch - 0x41 /* A */)
***REMOVED***
  if (ch >= 0x61 /* a */ && ch <= 0x66 /* f */) ***REMOVED***
    return 10 + (ch - 0x61 /* a */)
***REMOVED***
  return ch - 0x30 /* 0 */
***REMOVED***
...
pp$8.regexp_eatLegacyOctalEscapeSequence = function(state) ***REMOVED***
  if (this.regexp_eatOctalDigit(state)) ***REMOVED***
    var n1 = state.lastIntValue;
    if (this.regexp_eatOctalDigit(state)) ***REMOVED***
      var n2 = state.lastIntValue;
      if (n1 <= 3 && this.regexp_eatOctalDigit(state)) ***REMOVED***
...
pp$8.regexp_eatOctalDigit = function(state) ***REMOVED***
  var ch = state.current();
  if (isOctalDigit(ch)) ***REMOVED***
...
***REMOVED***
  ...
  return false
***REMOVED***;
function isOctalDigit(ch) ***REMOVED***
...
pp$8.regexp_eatFixedHexDigits = function(state, length) ***REMOVED***
  var start = state.pos;
  state.lastIntValue = 0;
  for (var i = 0; i < length; ++i) ***REMOVED***
    var ch = state.current();
    if (!isHexDigit(ch)) ***REMOVED***
      state.pos = start;
      return false
***REMOVED***
    state.lastIntValue = 16 * state.lastIntValue + hexToInt(ch);
...
pp$9.next = function(ignoreEscapeSequenceInKeyword) ***REMOVED***
  if (!ignoreEscapeSequenceInKeyword && this.type.keyword && this.containsEsc)
    ***REMOVED*** this.raiseRecoverable(this.start, "Escape sequence in keyword " + this.type.keyword); ***REMOVED***
...
pp$9.getToken = function() ***REMOVED***
  this.next();
...
if (typeof Symbol !== "undefined")
  ***REMOVED*** pp$9[Symbol.iterator] = function() ***REMOVED***
    var this$1 = this;
...
pp$9.curContext = function() ***REMOVED***
...
pp$9.nextToken = function() ***REMOVED***
...
pp$9.readToken = function(code) ***REMOVED***
...
pp$9.fullCharCodeAtPos = function() ***REMOVED***
...
pp$9.skipBlockComment = function() ***REMOVED***
...
pp$9.skipLineComment = function(startSkip) ***REMOVED***
  var start = this.pos;
  var startLoc = this.options.onComment && this.curPosition();
...
pp$9.skipSpace = function() ***REMOVED***
...
pp$9.finishToken = function(type, val) ***REMOVED***
  this.end = this.pos;
...
//
pp$9.readToken_dot = function() ***REMOVED***
  var next = this.input.charCodeAt(this.pos + 1);
...
pp$9.readToken_slash = function() ***REMOVED*** // '/'
  var next = this.input.charCodeAt(this.pos + 1);
...
pp$9.readToken_mult_modulo_exp = function(code) ***REMOVED*** // '%*'
  var next = this.input.charCodeAt(this.pos + 1);
  var size = 1;
...
pp$9.readToken_pipe_amp = function(code) ***REMOVED*** // '|&'
  var next = this.input.charCodeAt(this.pos + 1);
  if (next === code) ***REMOVED***
    if (this.options.ecmaVersion >= 12) ***REMOVED***
      var next2 = this.input.charCodeAt(this.pos + 2);
      if (next2 === 61) ***REMOVED*** return this.finishOp(types.assign, 3) ***REMOVED***
***REMOVED***
...
pp$9.readToken_caret = function() ***REMOVED*** // '^'
  var next = this.input.charCodeAt(this.pos + 1);
  if (next === 61) ***REMOVED*** return this.finishOp(types.assign, 2) ***REMOVED***
  return this.finishOp(types.bitwiseXOR, 1)
***REMOVED***;

pp$9.readToken_plus_min = function(code) ***REMOVED*** // '+-'
  var next = this.input.charCodeAt(this.pos + 1);
  if (next === code) ***REMOVED***
...
pp$9.readToken_lt_gt = function(code) ***REMOVED*** // '<>'
  var next = this.input.charCodeAt(this.pos + 1);
  var size = 1;
  if (next === code) ***REMOVED***
...
pp$9.readToken_eq_excl = function(code) ***REMOVED*** // '=!'
  var next = this.input.charCodeAt(this.pos + 1);
...
pp$9.readToken_question = function() ***REMOVED*** // '?'
  var ecmaVersion = this.options.ecmaVersion;
  if (ecmaVersion >= 11) ***REMOVED***
    var next = this.input.charCodeAt(this.pos + 1);
    if (next === 46) ***REMOVED***
      var next2 = this.input.charCodeAt(this.pos + 2);
      if (next2 < 48 || next2 > 57) ***REMOVED*** return this.finishOp(types.questionDot, 2) ***REMOVED***
***REMOVED***
    if (next === 63) ***REMOVED***
      if (ecmaVersion >= 12) ***REMOVED***
        var next2$1 = this.input.charCodeAt(this.pos + 2);
        if (next2$1 === 61) ***REMOVED*** return this.finishOp(types.assign, 3) ***REMOVED***
  ***REMOVED***
...
pp$9.getTokenFromCode = function(code) ***REMOVED***
  switch (code) ***REMOVED***
...
pp$9.finishOp = function(type, size) ***REMOVED***
  var str = this.input.slice(this.pos, this.pos + size);
  this.pos += size;
  return this.finishToken(type, str)
***REMOVED***;

pp$9.readRegexp = function() ***REMOVED***
  var escaped, inClass, start = this.pos;
  for (;;) ***REMOVED***
    if (this.pos >= this.input.length) ***REMOVED*** this.raise(start, "Unterminated regular expression"); ***REMOVED***
    var ch = this.input.charAt(this.pos);
    if (lineBreak.test(ch)) ***REMOVED*** this.raise(start, "Unterminated regular expression"); ***REMOVED***
    if (!escaped) ***REMOVED***
...
***REMOVED***
  ...
  return this.finishToken(types.regexp, ***REMOVED***pattern: pattern, flags: flags, value: value***REMOVED***)
***REMOVED***;
...
pp$9.readInt = function(radix, len, maybeLegacyOctalNumericLiteral) ***REMOVED***
  ...
  for (var i = 0, e = len == null ? Infinity : len; i < e; ++i, ++this.pos) ***REMOVED***
    var code = this.input.charCodeAt(this.pos), val = (void 0);

    if (allowSeparators && code === 95) ***REMOVED***
      if (isLegacyOctalNumericLiteral) ***REMOVED*** this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals"); ***REMOVED***
      if (lastCode === 95) ***REMOVED*** this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore"); ***REMOVED***
      if (i === 0) ***REMOVED*** this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits"); ***REMOVED***
      lastCode = code;
      continue
***REMOVED***
...
***REMOVED***
  ...
  if (allowSeparators && lastCode === 95) ***REMOVED*** this.raiseRecoverable(this.pos - 1, "Numeric separator is not allowed at the last of digits"); ***REMOVED***
  if (this.pos === start || len != null && this.pos - start !== len) ***REMOVED*** return null ***REMOVED***

  return total
***REMOVED***;

function stringToNumber(str, isLegacyOctalNumericLiteral) ***REMOVED***
  if (isLegacyOctalNumericLiteral) ***REMOVED***
...
function stringToBigInt(str) ***REMOVED***
  if (typeof BigInt !== "function") ***REMOVED***
    return null
***REMOVED***
...
pp$9.readRadixNumber = function(radix) ***REMOVED***
  var start = this.pos;
  this.pos += 2; // 0x
  var val = this.readInt(radix);
  if (val == null) ***REMOVED*** this.raise(this.start + 2, "Expected number in radix " + radix); ***REMOVED***
  if (this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110) ***REMOVED***
...
pp$9.readNumber = function(startsWithDot) ***REMOVED***
  var start = this.pos;
  if (!startsWithDot && this.readInt(10, undefined, true) === null) ***REMOVED*** this.raise(start, "Invalid number"); ***REMOVED***
  var octal = this.pos - start >= 2 && this.input.charCodeAt(start) === 48;
  if (octal && this.strict) ***REMOVED*** this.raise(start, "Invalid number"); ***REMOVED***
  var next = this.input.charCodeAt(this.pos);
  if (!octal && !startsWithDot && this.options.ecmaVersion >= 11 && next === 110) ***REMOVED***
...
pp$9.readCodePoint = function() ***REMOVED***
...
function codePointToString$1(code) ***REMOVED***
  // UTF-16 Decoding
...
pp$9.readString = function(quote) ***REMOVED***
  var out = "", chunkStart = ++this.pos;
  for (;;) ***REMOVED***
    if (this.pos >= this.input.length) ***REMOVED*** this.raise(this.start, "Unterminated string constant"); ***REMOVED***
    var ch = this.input.charCodeAt(this.pos);
    ...
    if (ch === 92) ***REMOVED*** // '\'
      ...
      chunkStart = this.pos;
***REMOVED*** else ***REMOVED***
      if (isNewLine(ch, this.options.ecmaVersion >= 10)) ***REMOVED*** this.raise(this.start, "Unterminated string constant"); ***REMOVED***
      ++this.pos;
***REMOVED***
***REMOVED***
  out += this.input.slice(chunkStart, this.pos++);
...
pp$9.tryReadTemplateToken = function() ***REMOVED***
...
pp$9.invalidStringToken = function(position, message) ***REMOVED***
...
pp$9.readTmplToken = function() ***REMOVED***
  var out = "", chunkStart = this.pos;
  for (;;) ***REMOVED***
    if (this.pos >= this.input.length) ***REMOVED*** this.raise(this.start, "Unterminated template"); ***REMOVED***
    var ch = this.input.charCodeAt(this.pos);
    if (ch === 96 || ch === 36 && this.input.charCodeAt(this.pos + 1) === 123) ***REMOVED*** // '`', '$***REMOVED***'
      if (this.pos === this.start && (this.type === types.template || this.type === types.invalidTemplate)) ***REMOVED***
        if (ch === 36) ***REMOVED***
          this.pos += 2;
...
***REMOVED*** else if (isNewLine(ch)) ***REMOVED***
      ...
      switch (ch) ***REMOVED***
      case 13:
        if (this.input.charCodeAt(this.pos) === 10) ***REMOVED*** ++this.pos; ***REMOVED***
      case 10:
        out += "\n";
        break
      default:
...
pp$9.readInvalidTemplateToken = function() ***REMOVED***
  for (; this.pos < this.input.length; this.pos++) ***REMOVED***
    switch (this.input[this.pos]) ***REMOVED***
    case "\\":
      ++this.pos;
      break

    case "$":
      if (this.input[this.pos + 1] !== "***REMOVED***") ***REMOVED***
        break
  ***REMOVED***
    // falls through
...
pp$9.readEscapedChar = function(inTemplate) ***REMOVED***
  var ch = this.input.charCodeAt(++this.pos);
  ++this.pos;
  switch (ch) ***REMOVED***
  case 110: return "\n" // 'n' -> '\n'
...
pp$9.readHexChar = function(len) ***REMOVED***
  var codePos = this.pos;
...
pp$9.readWord1 = function() ***REMOVED***
  this.containsEsc = false;
...
***REMOVED*** else if (ch === 92) ***REMOVED*** // "\"
      ...
      if (this.input.charCodeAt(++this.pos) !== 117) // "u"
        ***REMOVED*** this.invalidStringToken(this.pos, "Expecting Unicode escape sequence \\uXXXX"); ***REMOVED***
      ++this.pos;
      var esc = this.readCodePoint();
      if (!(first ? isIdentifierStart : isIdentifierChar)(esc, astral))
        ***REMOVED*** this.invalidStringToken(escStart, "Invalid Unicode escape"); ***REMOVED***
...
pp$9.readWord = function() ***REMOVED***
...
export ***REMOVED*** Node, Parser, Position, SourceLocation, TokContext, Token, TokenType, defaultOptions, getLineInfo, isIdentifierChar, isIdentifierStart, isNewLine, keywords$1 as keywordTypes, lineBreak, lineBreakG, nonASCIIwhitespace, parse, parseExpressionAt, types$1 as tokContexts, types as tokTypes, tokenizer, version ***REMOVED***;
