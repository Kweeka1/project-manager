...
function SortTemplate(comparator) ***REMOVED***
...
function doQuickSort(ary, comparator, p, r) ***REMOVED***
  ...
  if (p < r) ***REMOVED***
    ...
    for (var j = p; j < r; j++) ***REMOVED***
      if (comparator(ary[j], pivot, false) <= 0) ***REMOVED***
        i += 1;
        swap(ary, i, j);
  ***REMOVED***
***REMOVED***
...
function cloneSort(comparator) ***REMOVED***
  let template = SortTemplate.toString();
  let templateFn = new Function(`return $***REMOVED***template***REMOVED***`)();
...
exports.quickSort = function (ary, comparator, start = 0) ***REMOVED***
  let doQuickSort = sortCache.get(comparator);
  if (doQuickSort === void 0) ***REMOVED***
