 ...
 */
function lruMemoize(f) ***REMOVED***
  var cache = [];

  return function(input) ***REMOVED***
    for (var i = 0; i < cache.length; i++) ***REMOVED***
      if (cache[i].input === input) ***REMOVED***
        var temp = cache[0];
        cache[0] = cache[i];
        cache[i] = temp;
...
***REMOVED***
    ...
    cache.unshift(***REMOVED***
      input,
      result,
***REMOVED***);

    if (cache.length > MAX_CACHED_INPUTS) ***REMOVED***
      cache.pop();
***REMOVED***
 ...
 */
var normalize = lruMemoize(function normalize(aPath) ***REMOVED***
  var path = aPath;
...
***REMOVED*** else ***REMOVED***
      ...
      while (i < path.length && path[i] === "/") ***REMOVED***
        i++;
  ***REMOVED***
***REMOVED***
***REMOVED***
...
function compareByOriginalPositionsNoSource(mappingA, mappingB, onlyCompareOriginal) ***REMOVED***
  var cmp
...
function compareByGeneratedPositionsDeflatedNoLine(mappingA, mappingB, onlyCompareGenerated) ***REMOVED***
