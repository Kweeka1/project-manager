...
***REMOVED***
    ...
    for (var i = 0, n = mappings.length; i < n; i++) ***REMOVED***
      var mapping = mappings[i];
      var source = mapping.source === null ? null : sources.at(mapping.source);
      source = util.computeSourceURL(sourceRoot, source, sourceMapURL);
      boundCallback(***REMOVED***
        source: source,
...
function sortGenerated(array, start) ***REMOVED***
  let l = array.length;
  let n = array.length - start;
  if (n <= 1) ***REMOVED***
    return;
***REMOVED*** else if (n == 2) ***REMOVED***
    let a = array[start];
    let b = array[start + 1];
    if (compareGenerated(a, b) > 0) ***REMOVED***
      array[start] = b;
      array[start + 1] = a;
***REMOVED***
***REMOVED*** else if (n < 20) ***REMOVED***
    for (let i = start; i < l; i++) ***REMOVED***
      for (let j = i; j > start; j--) ***REMOVED***
        let a = array[j - 1];
        let b = array[j];
        if (compareGenerated(a, b) <= 0) ***REMOVED***
          break;
  ...
  ***REMOVED***
    ...
    ***REMOVED***
        ...
        if (typeof mapping.originalLine === 'number') ***REMOVED***
          ...
          while (originalMappings.length <= currentSource) ***REMOVED***
            originalMappings.push(null);
      ***REMOVED***
          if (originalMappings[currentSource] === null) ***REMOVED***
...
***REMOVED***
    ...
    for (var i = 0; i < originalMappings.length; i++) ***REMOVED***
      if (originalMappings[i] != null) ***REMOVED***
