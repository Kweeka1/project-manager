import ***REMOVED*** Document, scalarOptions ***REMOVED*** from './index'
import ***REMOVED*** CST ***REMOVED*** from './parse-cst'
import ***REMOVED*** Type ***REMOVED*** from './util'
...
export class Schema ***REMOVED***
  /** Default: `'tag:yaml.org,2002:'` */
  static defaultPrefix: string
  static defaultTags: ***REMOVED***
...
***REMOVED***
   ...
   *
   * @param ctx To not wrap scalars, use a context `***REMOVED*** wrapScalars: false ***REMOVED***`
   */
...
***REMOVED***
  ...
  interface CreateNodeContext ***REMOVED***
    wrapScalars?: boolean
    [key: string]: any
***REMOVED***

  interface StringifyContext ***REMOVED***
...
***REMOVED***
  ...
  interface CustomTag extends BaseTag ***REMOVED***
    /**
...
***REMOVED***
  ...
  interface DefaultTag extends BaseTag ***REMOVED***
    /**
...
export class Scalar extends Node ***REMOVED***
  ...
  toString(): string
***REMOVED***
export namespace Scalar ***REMOVED***
  type Type =
    | Type.BLOCK_FOLDED
    | Type.BLOCK_LITERAL
    | Type.PLAIN
...
export class Alias extends Node ***REMOVED***
  type: Type.ALIAS
  source: Node
  cstNode?: CST.Alias
...
export class Pair extends Node ***REMOVED***
...
export class Merge extends Pair ***REMOVED***
...
export class Collection extends Node ***REMOVED***
   ...
   * be a Pair instance or a `***REMOVED*** key, value ***REMOVED***` object, which may not have a key
...
export class YAMLMap extends Collection ***REMOVED***
...
export class YAMLSeq extends Collection ***REMOVED***
...
export namespace AST ***REMOVED***
  interface NodeToJsonContext ***REMOVED***
    anchors?: any[]
    doc: Document
    keep?: boolean
    mapAsMap?: boolean
...
***REMOVED***
  ...
  interface BlockFolded extends Scalar ***REMOVED***
    type: Type.BLOCK_FOLDED
    cstNode?: CST.BlockFolded
***REMOVED***

  interface BlockLiteral extends Scalar ***REMOVED***
    type: Type.BLOCK_LITERAL
    cstNode?: CST.BlockLiteral
***REMOVED***

  interface PlainValue extends Scalar ***REMOVED***
    type: Type.PLAIN
    cstNode?: CST.PlainValue
***REMOVED***

  interface QuoteDouble extends Scalar ***REMOVED***
    type: Type.QUOTE_DOUBLE
    cstNode?: CST.QuoteDouble
***REMOVED***

  interface QuoteSingle extends Scalar ***REMOVED***
    type: Type.QUOTE_SINGLE
    cstNode?: CST.QuoteSingle
***REMOVED***

  interface FlowMap extends YAMLMap ***REMOVED***
    type: Type.FLOW_MAP
    cstNode?: CST.FlowMap
***REMOVED***

  interface BlockMap extends YAMLMap ***REMOVED***
    type: Type.MAP
    cstNode?: CST.Map
***REMOVED***

  interface FlowSeq extends YAMLSeq ***REMOVED***
    type: Type.FLOW_SEQ
    items: Array<Node>
    cstNode?: CST.FlowSeq
***REMOVED***

  interface BlockSeq extends YAMLSeq ***REMOVED***
    type: Type.SEQ
