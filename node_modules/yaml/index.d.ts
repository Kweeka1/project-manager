...
import ***REMOVED***
  ...
  YAMLSeq
***REMOVED*** from './types'
import ***REMOVED*** Type, YAMLError, YAMLWarning ***REMOVED*** from './util'

export ***REMOVED*** AST, CST ***REMOVED***
export ***REMOVED*** default as parseCST ***REMOVED*** from './parse-cst'
...
export interface Options extends Schema.Options ***REMOVED***
  /**
 ...
 */
export const scalarOptions: ***REMOVED***
...
***REMOVED***
export namespace scalarOptions ***REMOVED***
  interface Binary ***REMOVED***
    /**
...
export class Document extends Collection ***REMOVED***
...
export namespace Document ***REMOVED***
  interface Parsed extends Document ***REMOVED***
    contents: Scalar | YAMLMap | YAMLSeq | null
    /** The schema used with the document. */
    schema: Schema
***REMOVED***

  interface Anchors ***REMOVED***
    /**
