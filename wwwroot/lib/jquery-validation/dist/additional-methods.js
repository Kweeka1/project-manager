	...
	if ( $( element ).attr( "type" ) === "file" ) ***REMOVED***
		...
		if ( element.files && element.files.length ) ***REMOVED***
			...
			for ( i = 0; i < element.files.length; i++ ) ***REMOVED***
				...
				if ( !file.type.match( regex ) ) ***REMOVED***
					return false;
				***REMOVED***
			***REMOVED***
		***REMOVED***
...
$.validator.addMethod( "bic", function( value, element ) ***REMOVED***
    return this.optional( element ) || /^([A-Z]***REMOVED***6***REMOVED***[A-Z2-9][A-NP-Z1-9])(X***REMOVED***3***REMOVED***|[A-WY-Z0-9][A-Z0-9]***REMOVED***2***REMOVED***)?$/.test( value.toUpperCase() );
 ...
 *
 */
$.validator.addMethod( "cifES", function( value, element ) ***REMOVED***
	"use strict";
	...
	***REMOVED***
	...
	var cifRegEx = new RegExp( /^([ABCDEFGHJKLMNPQRSUVW])(\d***REMOVED***7***REMOVED***)([0-9A-J])$/gi );
	...
	function isOdd( n ) ***REMOVED***
		return n % 2 === 0;
	***REMOVED***

	// Quick format test
	if ( value.length !== 9 || !cifRegEx.test( value ) ) ***REMOVED***
		return false;
	***REMOVED***

	for ( i = 0; i < number.length; i++ ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( letter.match( /[ABEH]/ ) ) ***REMOVED***
		return control === control_digit;

	// Control must be a letter
	***REMOVED*** else if ( letter.match( /[KPQS]/ ) ) ***REMOVED***
...
$.validator.addMethod( "cpfBR", function( value ) ***REMOVED***
	...
	***REMOVED***
	...
	checkResult = function( sum, cn ) ***REMOVED***
		...
		if ( ( result === 10 ) || ( result === 11 ) ) ***REMOVED***
			result = 0;
		***REMOVED***
		return ( result === cn );
	***REMOVED***;
...
$.validator.addMethod( "creditcard", function( value, element ) ***REMOVED***
	if ( this.optional( element ) ) ***REMOVED***
...
$.validator.addMethod( "iban", function( value, element ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( iban.length < minimalIBANlength ) ***REMOVED***
		return false;
	***REMOVED***

	// Check the country code and find the country specific format
	countrycode = iban.substring( 0, 2 );
	bbancountrypatterns = ***REMOVED***
...
$.validator.addMethod( "netmask", function( value, element ) ***REMOVED***
 ...
 */
$.validator.addMethod( "nieES", function( value, element ) ***REMOVED***
	"use strict";
	...
	***REMOVED***
	...
	var nieRegEx = new RegExp( /^[MXYZ]***REMOVED***1***REMOVED***[0-9]***REMOVED***7,8***REMOVED***[TRWAGMYFPDXBNJZSQVHLCKET]***REMOVED***1***REMOVED***$/gi );
	...
	// Quick format test
	if ( value.length > 10 || value.length < 9 || !nieRegEx.test( value ) ) ***REMOVED***
		return false;
	***REMOVED***
 ...
 */
$.validator.addMethod( "nifES", function( value, element ) ***REMOVED***
	"use strict";
 ...
 */
$.validator.addMethod( "nipPL", function( value ) ***REMOVED***
	"use strict";
...
$.validator.addMethod( "notEqualTo", function( value, element, param ) ***REMOVED***
